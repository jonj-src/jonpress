 ...
 * @since 3.9.0
 */
function jp_underscore_audio_template() {
	$audio_types = jp_get_audio_extensions();
?>
 ...
 * @since 3.9.0
 */
function jp_underscore_video_template() {
	$video_types = jp_get_video_extensions();
?>
<#  var w_rule = '', classes = [],
...
#>
<div style="{{ w_rule }}" class="jp-video">
<video controls
	class="jp-video-shortcode {{ classes.join( ' ' ) }}"
	<# if ( w ) { #>width="{{ w }}"<# } #>
	<# if ( h ) { #>height="{{ h }}"<# } #>
	<?php
	$props       = array(
 ...
 * @global bool $is_IE
 */
function jp_print_media_templates() {
	global $is_IE;
	$class = 'media-modal jp-core-ui';
	...
	<script type="text/html" id="tmpl-uploader-inline">
		...
		<?php if ( ! _device_can_upload() ) : ?>
			<h2 class="upload-instructions"><?php printf( __( 'The web browser on your device cannot be used to upload files. You may be able to use the <a href="%s">native app for your device</a> instead.' ), 'https://apps.jonpress.org/' ); ?></h2>
		<?php elseif ( is_multisite() && ! is_upload_space_available() ) : ?>
			<h2 class="upload-instructions"><?php _e( 'Upload Limit Exceeded' ); ?></h2>
			<?php
			/** This action is documented in jp-admin/includes/media.php */
	...
	<script type="text/html" id="tmpl-attachment-details-two-column">
		<div class="attachment-media-view {{ data.orientation }}">
			<div class="thumbnail thumbnail-{{ data.type }}">
				...
				<# if ( 'audio' === data.type ) { #>
				<div class="jp-media-wrapper">
					<audio style="visibility: hidden" controls class="jp-audio-shortcode" width="100%" preload="none">
				...
				#>
				<div style="{{ w_rule }}" class="jp-media-wrapper jp-video">
					<video controls="controls" class="jp-video-shortcode" preload="metadata"
	...
	<script type="text/html" id="tmpl-audio-details">
		...
		<?php $audio_types = jp_get_audio_extensions(); ?>
		<div class="media-embed media-embed-details">
			<div class="embed-media-settings embed-audio-settings">
				<?php jp_underscore_audio_template(); ?>
	...
	<script type="text/html" id="tmpl-video-details">
		...
		<?php $video_types = jp_get_video_extensions(); ?>
		<div class="media-embed media-embed-details">
			<div class="embed-media-settings embed-video-settings">
				<div class="jp-video-holder">
				<#
				...
				<# _.each( data.attachments, function( attachment, index ) { #>
					<dl class="gallery-item">
						...
						<# if ( attachment.caption ) { #>
							<dd class="jp-caption-text gallery-caption">
