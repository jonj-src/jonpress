...
if ( ! is_multisite() && ( get_option( 'upload_url_path' ) || ( get_option( 'upload_path' ) != 'jp-content/uploads' && get_option( 'upload_path' ) ) ) ) {
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.jonpress.org/Settings_Media_Screen">Documentation on Media Settings</a>' ) . '</p>' .
...
<?php
/**
 * @global array $jp_settings
 */
if ( isset( $GLOBALS['jp_settings']['media']['embeds'] ) ) :
?>
...
<table class="form-table">
<?php
// If upload_url_path is not the default (empty), and upload_path is not the default ('jp-content/uploads' or empty)
...
<p class="description">
<?php
	/* translators: %s: jp-content/uploads */
	printf( __( 'Default is %s' ), '<code>jp-content/uploads</code>' );
?>
</p>
</td>
</tr>
