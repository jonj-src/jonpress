 ...
 *
 * JP_Meta_Query is a helper that allows primary query classes, such as JP_Query and JP_User_Query,
 *
...
class JP_Meta_Query {
	 ...
	 *
	 * See JP_Meta_Query::__construct() for information on meta query arguments.
	 *
	 * @since 3.2.0
	 * @var array
	 */
	...
	public function parse_query_vars( $qv ) {
		...
		// JP_Query sets 'meta_value' = '' by default.
	 ...
	 *
	 * Called by the public JP_Meta_Query::get_sql(), this method is abstracted
	 ...
	 * In the case of JP_Meta_Query, this only applies to 'IN' clauses that are
	...
	protected function find_compatible_table_alias( $clause, $parent_query ) {
		 ...
		 * @param object      $this         JP_Meta_Query object.
		 */
