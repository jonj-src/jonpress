<?php
/**
 * Customize API: JP_Customize_Header_Image_Control class
 *
 * @package JonPress
 ...
 */
class JP_Customize_Header_Image_Control extends JP_Customize_Image_Control {
	public $type = 'header';
	...
	public function enqueue() {
		jp_enqueue_media();
		jp_enqueue_script( 'customize-views' );
		...
		jp_localize_script(
			'customize-views', '_wpCustomizeHeader', array(
				...
				'nonces'   => array(
					'add'    => jp_create_nonce( 'header-add' ),
					'remove' => jp_create_nonce( 'header-remove' ),
				),
