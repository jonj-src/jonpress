<?php
/**
 * Locale API: JP_Locale_Switcher class
 *
 * @package JonPress
 * @subpackage i18n
 * @since 4.7.0
...
class JP_Locale_Switcher {
	...
	/**
	 * Filters the locale of the JonPress installation.
	 *
	 * @since 4.7.0
	 *
	 * @param string $locale The locale of the JonPress installation.
	 ...
	 *
	 * Loads the translations, changes the global `$jp_locale` object and updates
