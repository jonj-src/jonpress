<?php
/**
 * Feed API: JP_SimplePie_Sanitize_KSES class
 *
 * @package JonPress
 * @subpackage Feed
 * @since 4.7.0
 ...
 */
class JP_SimplePie_Sanitize_KSES extends SimplePie_Sanitize {

	/**
	 * JonPress SimplePie sanitization using KSES.
	 *
