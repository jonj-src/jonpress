...
function get_post_type_archive_template() {
	...
	if ( ! ( $obj instanceof JP_Post_Type ) || ! $obj->has_archive ) {
		return '';
	}
 ...
 *
 * Searches in the STYLESHEETPATH before TEMPLATEPATH and jp-includes/theme-compat
...
/**
 * Require the template file with JonPress environment.
 *
 * The globals are set up for the template file to ensure that the JonPress
...
function load_template( $_template_file, $require_once = true ) {
	global $posts, $post, $jp_did_header, $jp_query, $jp_rewrite, $wpdb, $jp_version, $wp, $id, $comment, $user_ID;

	if ( is_array( $jp_query->query_vars ) ) {
		extract( $jp_query->query_vars, EXTR_SKIP );
	}
