 ...
 *
 * These functions must be used within the JonPress Loop.
 *
 * @link https://codex.jonpress.org/Author_Templates
 *
 * @package JonPress
 * @subpackage Template
 */
 ...
 * @since 0.71
 * @see get_the_author()
 * @link https://codex.jonpress.org/Template_Tags/the_author
 *
 * @param string $deprecated Deprecated.
 ...
 * author's name.
 *
 * @link https://codex.jonpress.org/Template_Tags/the_author_link
 *
 * @since 2.1.0
 */
 ...
 *
 * @link https://codex.jonpress.org/Template_Tags/the_author_posts
 * @since 0.71
 */
...
function get_author_posts_url( $author_id, $author_nicename = '' ) {
	...
	$link    = $jp_rewrite->get_author_permastruct();
 ...
 *
 * @link https://codex.jonpress.org/Template_Tags/jp_list_authors
 *
 * @since 1.2.0
 *
...
function jp_list_authors( $args = '' ) {
	...
	$query_args           = jp_array_slice_assoc( $args, array( 'orderby', 'order', 'number', 'exclude', 'include' ) );
