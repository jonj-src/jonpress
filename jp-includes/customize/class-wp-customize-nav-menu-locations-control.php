<?php
/**
 * Customize API: JP_Customize_Nav_Menu_Locations_Control class
 *
 * @package JonPress
 ...
 * @since 4.9.0
 */
class JP_Customize_Nav_Menu_Locations_Control extends JP_Customize_Control {
						...
						<p>
							...
							<em class="new-menu-locations-widget-note">
								...
								printf(
									...
									__( 'https://codex.jonpress.org/JonPress_Widgets' ),
