<?php
/**
 * Dependencies API: JP_Scripts class
 *
 * @since 2.6.0
 *
 * @package JonPress
 ...
 * @see JP_Dependencies
 */
class JP_Scripts extends JP_Dependencies {
	/**
	...
	public function init() {
		/**
		 * Fires when the JP_Scripts instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param JP_Scripts $this JP_Scripts instance (passed by reference).
		 */
		do_action_ref_array( 'jp_default_scripts', array( &$this ) );
	}
	...
	public function print_scripts_l10n( $handle, $echo = true ) {
		_deprecated_function( __FUNCTION__, '3.3.0', 'JP_Scripts::print_extra_script()' );
	...
	public function localize( $handle, $object_name, $l10n ) {
		...
		$script = "var $object_name = " . jp_json_encode( $l10n ) . ';';
