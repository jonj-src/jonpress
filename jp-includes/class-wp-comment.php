...
final class JP_Comment {
	...
	/**
	 * Retrieves a JP_Comment instance.
	 *
	 * @since 4.4.0
	 *
	 ...
	 * @return JP_Comment|false Comment object, otherwise false.
	 */
	public static function get_instance( $id ) {
		...
		$_comment = jp_cache_get( $comment_id, 'comment' );
		...
		if ( ! $_comment ) {
			...
			jp_cache_add( $_comment->comment_ID, $_comment, 'comment' );
		}

		return new JP_Comment( $_comment );
	}
	 ...
	 *                                 stored in a `children` property on the `JP_Comment` object.
	 ...
	 * }
	 * @return array Array of `JP_Comment` objects.
	 */
	public function get_children( $args = array() ) {
		...
		$_args           = jp_parse_args( $args, $defaults );
	 ...
	 *
	 * Used by `JP_Comment_Query` when bulk-filling descendants.
	 *
	 * @since 4.4.0
	 *
	 * @param JP_Comment $child Child comment.
	 */
	public function add_child( JP_Comment $child ) {
	 ...
	 * @return JP_Comment|bool Returns the comment object if found, otherwise false.
	 */
