<?php
/**
 * Widget API: JP_Widget_RSS class
 *
 * @package JonPress
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see JP_Widget
 */
class JP_Widget_RSS extends JP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		jp_widget_rss_output( $rss, $instance );
	...
	public function update( $new_instance, $old_instance ) {
		...
		return jp_widget_rss_process( $new_instance, $testurl );
	}
