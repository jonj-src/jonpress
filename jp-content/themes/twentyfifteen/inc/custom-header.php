...
/**
 * Set up the JonPress core custom header feature.
 *
...
function twentyfifteen_custom_header_setup() {
	 ...
	 *     @type string $jp-head-callback       Callback function used to styles the header image and text
	...
	add_theme_support(
		'custom-header', apply_filters(
			'twentyfifteen_custom_header_args', array(
				...
				'width'              => 954,
				'height'             => 1300,
				'jp-head-callback'   => 'twentyfifteen_header_style',
			)
		)
	);
}
...
if ( ! function_exists( 'twentyfifteen_header_style' ) ) :
	...
	?>
		.site-header {
			 ...
			 * @see https://core.trac.jonpress.org/ticket/31460
			 */
...
function twentyfifteen_header_background_color_css() {
	...
	jp_add_inline_style( 'twentyfifteen-style', sprintf( $css, $header_background_color ) );
}
add_action( 'jp_enqueue_scripts', 'twentyfifteen_header_background_color_css', 11 );
...
function twentyfifteen_sidebar_text_color_css() {
	...
	jp_add_inline_style( 'twentyfifteen-style', sprintf( $css, $sidebar_link_color, $sidebar_text_color, $sidebar_border_color, $sidebar_border_focus_color ) );
}
add_action( 'jp_enqueue_scripts', 'twentyfifteen_sidebar_text_color_css', 11 );
