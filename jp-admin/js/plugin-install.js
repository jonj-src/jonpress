...
jQuery( document ).ready( function( $ ) {
	 ...
	 * @todo Consider to implement a JonPress general utility for this and don't use jQuery UI.
	 */
	function handleTabbables() {
		...
		$firstAndLast.off( 'keydown.jp-plugin-details' );
		// Attach again the keydown event on the first and last focusable elements.
		$firstAndLast.on( 'keydown.jp-plugin-details', function( event ) {
