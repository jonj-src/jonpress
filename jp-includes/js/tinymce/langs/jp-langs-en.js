...
( function() {
	...
	tinyMCE.addI18n( lang + ".jonpress", {
		jp_adv_desc: "Show/Hide Kitchen Sink (Alt + Shift + Z)",
		jp_more_desc: "Insert More Tag (Alt + Shift + T)",
		jp_page_desc: "Insert Page break (Alt + Shift + P)",
		jp_help_desc: "Help (Alt + Shift + H)",
		jp_more_alt: "More...",
		jp_page_alt: "Next page...",
		add_media: "Add Media",
		...
		jp_fullscreen_desc: "Distraction-free writing mode (Alt + Shift + W)"
	});
