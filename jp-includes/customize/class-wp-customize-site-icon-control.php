<?php
/**
 * Customize API: JP_Customize_Site_Icon_Control class
 *
 * @package JonPress
 ...
 * @since 4.3.0
 *
 * @see JP_Customize_Cropped_Image_Control
 */
class JP_Customize_Site_Icon_Control extends JP_Customize_Cropped_Image_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		add_action( 'customize_controls_print_styles', 'jp_site_icon', 99 );
	}
		...
		<# if ( data.attachment && data.attachment.id ) { #>
			<div class="attachment-media-view">
				<# if ( data.attachment.sizes ) { #>
					<div class="site-icon-preview jp-clearfix">
