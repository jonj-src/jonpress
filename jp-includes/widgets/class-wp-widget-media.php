<?php
/**
 * Widget API: JP_Media_Widget class
 *
 * @package JonPress
 * @subpackage Widgets
 * @since 4.8.0
 ...
 * @see JP_Widget
 */
abstract class JP_Widget_Media extends JP_Widget {
	 ...
	 * @param array  $widget_options  Optional. Widget options. See jp_register_sidebar_widget() for
	 *                                information on accepted arguments. Default empty array.
	 * @param array  $control_options Optional. Widget control options. See jp_register_widget_control()
	 *                                for information on accepted arguments. Default empty array.
	 */
	public function __construct( $id_base, $name, $widget_options = array(), $control_options = array() ) {
		$widget_opts = jp_parse_args(
		...
		$control_opts = jp_parse_args( $control_options, array() );
	 ...
	 * @since  4.8.0
	 *
	 * @see JP_REST_Controller::get_item_schema()
	 * @see JP_REST_Controller::get_additional_fields()
	 * @link https://core.trac.jonpress.org/ticket/35574
	...
	public function get_instance_schema() {
		 ...
		 * @param JP_Widget_Media $this   Widget object.
		 */
	 ...
	 * @since 4.8.0
	 *
	 * @param int|JP_Post $attachment Attachment post ID or object.
	...
	public function is_attachment_with_mime_type( $attachment, $mime_type ) {
		...
		return jp_attachment_is( $mime_type, $attachment );
	}
	 ...
	 * @since 4.8.0
	 *
	 * @see JP_Widget::widget()
	 *
	 * @param array $args     Display arguments including before_title, after_title, before_widget, and after_widget.
	 * @param array $instance Saved setting from the database.
	 */
	public function widget( $args, $instance ) {
		$instance = jp_parse_args( $instance, jp_list_pluck( $this->get_instance_schema(), 'default' ) );
	...
	public function update( $new_instance, $instance ) {
		...
		foreach ( $schema as $field => $field_schema ) {
			...
			if ( is_jp_error( $value ) ) {
				continue; // Handle case when rest_sanitize_value_from_schema() ever returns JP_Error as its phpdoc @return tag indicates.
			}
	 ...
	 * @since 4.8.0
	 *
	 * @see \JP_Widget_Media::render_control_template_scripts() Where the JS template is located.
	 * @param array $instance Current settings.
	 * @return void
	 */
	final public function form( $instance ) {
		$instance_schema = $this->get_instance_schema();
		$instance        = jp_array_slice_assoc(
			jp_parse_args( (array) $instance, jp_list_pluck( $instance_schema, 'default' ) ),
	...
	public function enqueue_admin_scripts() {
		jp_enqueue_media();
		jp_enqueue_script( 'media-widgets' );
	}
