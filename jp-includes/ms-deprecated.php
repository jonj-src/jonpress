<?php
/**
 * Deprecated functions from JonPress MU and the multisite feature. You shouldn't
 ...
 * Dashboard blog functionality was removed in JonPress 3.1, replaced by the user admin.
 *
 * @since MU (3.0.0)
 * @deprecated 3.1.0 Use get_site()
 * @see get_site()
 *
 * @return JP_Site Current site object.
 */
 ...
 *
 * @since MU (3.0.0)
 * @deprecated 3.0.0 Use jp_generate_password()
 * @see jp_generate_password()
 *
 * @param int $len Optional. The length of password to generate. Default 8.
 */
function generate_random_password( $len = 8 ) {
	_deprecated_function( __FUNCTION__, '3.0.0', 'jp_generate_password()' );
	return jp_generate_password( $len );
}
 ...
 *
 * @since MU (3.0.0)
 * @deprecated 3.0.0 Use jp_die()
 * @see jp_die()
 */
function graceful_fail( $message ) {
	_deprecated_function( __FUNCTION__, '3.0.0', 'jp_die()' );
 ...
 *
 * @since MU (3.0.0)
 * @deprecated 3.0.0 Use jp_get_sites()
 * @see jp_get_sites()
 *
...
function get_blog_list( $start = 0, $num = 10, $deprecated = '' ) {
	_deprecated_function( __FUNCTION__, '3.0.0', 'jp_get_sites()' );
 ...
 *
 * @since MU (3.0.0)
 * @deprecated 3.3.0 Use jp_redirect()
 * @see jp_redirect()
 *
 * @param string $url Optional. Redirect URL. Default empty.
 */
function wpmu_admin_do_redirect( $url = '' ) {
	_deprecated_function( __FUNCTION__, '3.3.0', 'jp_redirect()' );
	...
	if ( ! empty( $_SERVER['HTTP_REFERER'] ) ) {
		jp_redirect( $_SERVER['HTTP_REFERER'] );
		exit();
	}
...
function create_empty_blog( $domain, $path, $weblog_title, $site_id = 1 ) {
	...
	// Need to back up wpdb table names, and create a new jp_blogs entry for new blog.
	// Need to get blog_id from jp_blogs, and create new table names.
 ...
 * }
 * @return array An empty array if the installation is considered "large" via jp_is_large_network(). Otherwise,
 ...
 */
function jp_get_sites( $args = array() ) {
