...
add_action( 'jp_footer', 'twentyseventeen_include_svg_icons', 9999 );
...
function twentyseventeen_get_svg( $args = array() ) {
	 ...
	 *
	 * See https://core.trac.jonpress.org/ticket/38387.
	 */
 ...
 * @param  JP_Post $item  The current menu item.
 * @param  array   $args  An array of jp_nav_menu() arguments.
...
function twentyseventeen_social_links_icons() {
	...
	$social_links_icons = array(
		...
		'vine.co'         => 'vine',
		'vk.com'          => 'vk',
		'jonpress.org'   => 'jonpress',
		'jonpress.com'   => 'jonpress',
		'yelp.com'        => 'yelp',
		'youtube.com'     => 'youtube',
	);
