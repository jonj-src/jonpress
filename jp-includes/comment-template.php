 ...
 *
 * These functions are meant to live inside of the JonPress loop.
 *
 * @package JonPress
 * @subpackage Template
 */
 ...
 *
 * @since 1.5.0
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or the ID of the comment for which to retrieve the author.
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or the ID of the comment for which to print the author.
 *                                   Default current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or the ID of the comment for which to get the author's email.
 *                                   Default current comment.
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or the ID of the comment for which to print the author's email.
 *                                   Default current comment.
 */
 ...
 * @param int|JP_Comment $comment  Optional. Comment ID or JP_Comment object. Default is the current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or the ID of the comment for which to get the author's link.
 *                                   Default current comment.
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or the ID of the comment for which to print the author's link.
 *                                   Default current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or the ID of the comment for which to get the author's IP address.
 *                                   Default current comment.
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or the ID of the comment for which to print the author's IP address.
 *                                   Default current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or the ID of the comment for which to get the author's URL.
 *                                   Default current comment.
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or the ID of the comment for which to print the author's URL.
 *                                   Default current comment.
 */
 ...
 *                                 Default empty.
 * @param int|JP_Comment $comment  Optional. Comment ID or JP_Comment object.
 ...
 *
 * @since 2.7.0
 * @since 4.4.0 Added the ability for `$comment` to also accept a JP_Comment object.
 *
 * @param string|array   $class    Optional. One or more classes to add to the class list.
 *                                 Default empty.
 * @param int|JP_Comment $comment  Comment ID or JP_Comment object. Default current comment.
 * @param int|JP_Post    $post_id  Post ID or JP_Post object. Default current post.
 ...
 * @param int|JP_Comment $comment_id Comment ID or JP_Comment object. Default current comment.
 * @param int|JP_Post    $post_id    Post ID or JP_Post object. Default current post.
...
function get_comment_class( $class = '', $comment_id = null, $post_id = null ) {
	 ...
	 * @param int         $comment_id The comment id.
	 * @param JP_Comment  $comment    The comment object.
	 * @param int|JP_Post $post_id    The post ID or JP_Post object.
	 */
 ...
 * @param int|JP_Comment  $comment_ID JP_Comment or ID of the comment for which to get the date.
 *                                    Default current comment.
 ...
 * @param int|JP_Comment $comment_ID JP_Comment or ID of the comment for which to print the date.
 *                                   Default current comment.
 */
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID  JP_Comment or ID of the comment for which to get the excerpt.
 *                                    Default current comment.
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID  JP_Comment or ID of the comment for which to print the excerpt.
 *                                    Default current comment.
 */
 ...
 *
 * @since 1.5.0
 * @since 4.4.0 Added the ability for `$comment` to also accept a JP_Comment object. Added `$cpage` argument.
 *
 ...
 *
 * @param JP_Comment|int|null $comment Comment to retrieve. Default current comment.
 * @param array               $args {
...
function get_comment_link( $comment = null, $args = array() ) {
	global $jp_rewrite, $in_comment_loop;
	...
	if ( $cpage && get_option( 'page_comments' ) ) {
		if ( $jp_rewrite->using_permalinks() ) {
			if ( $cpage ) {
				$link = trailingslashit( $link ) . $jp_rewrite->comments_pagination_base . '-' . $cpage;
			}
	 ...
	 * @param JP_Comment $comment The current comment object.
...
function get_comments_link( $post_id = 0 ) {
	 ...
	 * @param int|JP_Post $post_id       Post ID or JP_Post object.
	 */
 ...
 * @since 1.5.0
 *
 * @param int|JP_Post $post_id Optional. Post ID or JP_Post object. Default is the global `$post`.
 ...
 *
 * @param int|JP_Comment  $comment_ID JP_Comment or ID of the comment for which to get the text.
 *                                    Default current comment.
 ...
 * @see Walker_Comment::comment()
 *
 * @param int|JP_Comment  $comment_ID JP_Comment or ID of the comment for which to print the text.
 *                                    Default current comment.
...
function comment_text( $comment_ID = 0, $args = array() ) {
	 ...
	 * @param JP_Comment|null $comment      The comment object.
	 * @param array           $args         An array of arguments.
	 */
 ...
 * @since 4.4.0 Added the ability for `$comment_ID` to also accept a JP_Comment object.
 *
 * @param int|JP_Comment $comment_ID Optional. JP_Comment or ID of the comment for which to get the type.
 *                                   Default current comment.
...
function get_trackback_url() {
	if ( '' != get_option( 'permalink_structure' ) ) {
		...
		$tb_url = get_option( 'siteurl' ) . '/jp-trackback.php?p=' . get_the_ID();
	}
 ...
 * @since 2.1.3
 */
function jp_comment_form_unfiltered_html_nonce() {
	$post    = get_post();
	$post_id = $post ? $post->ID : 0;

	if ( current_user_can( 'unfiltered_html' ) ) {
		jp_nonce_field( 'unfiltered-html-comment_' . $post_id, '_jp_unfiltered_html_comment_disabled', false );
		echo "<script>(function(){if(window===window.parent){document.getElementById('_jp_unfiltered_html_comment_disabled').name='_jp_unfiltered_html_comment';}})();</script>\n";
	}
}
 ...
 *
 * Uses the JonPress database object to query for the comments. The comments
 ...
 * default theme. If either does not exist, then the JonPress process will be
...
function comments_template( $file = '/comments.php', $separate_comments = false ) {
	global $jp_query, $withcomments, $post, $wpdb, $id, $comment, $user_login, $user_ID, $user_identity, $overridden_cpage;
	 ...
	 */
	$commenter = jp_get_current_commenter();
	...
	if ( get_option( 'page_comments' ) ) {
		...
		if ( $page ) {
			...
			$top_level_query = new JP_Comment_Query();
	 ...
	 * @since 4.5.0
	 *
	 * @see JP_Comment_Query::__construct()
	 *
	 * @param array $comment_args {
	 *     Array of JP_Comment_Query arguments.
	 *
	...
	$comment_query = new JP_Comment_Query( $comment_args );
	 ...
	 * @param int   $post_ID  Post ID.
	 */
	$jp_query->comments = apply_filters( 'comments_array', $comments_flat, $post->ID );

	$comments                        = &$jp_query->comments;
	$jp_query->comment_count         = count( $jp_query->comments );
	$jp_query->max_num_comment_pages = $comment_query->max_num_pages;

	if ( $separate_comments ) {
		$jp_query->comments_by_type = separate_comments( $comments );
		$comments_by_type           = &$jp_query->comments_by_type;
	} else {
		$jp_query->comments_by_type = array();
	}

	$overridden_cpage = false;
	if ( '' == get_query_var( 'cpage' ) && $jp_query->max_num_comment_pages > 1 ) {
 ...
 * }
 * @param int|JP_Comment $comment Comment being replied to. Default current comment.
 * @param int|JP_Post    $post    Post ID or JP_Post object the comment is going to be displayed on.
...
function get_comment_reply_link( $args = array(), $comment = null, $post = null ) {
	 ...
	 * @param JP_Comment $comment The object of the comment being replied to.
	 * @param JP_Post    $post    The JP_Post object.
	 */
	...
	if ( get_option( 'comment_registration' ) && ! is_user_logged_in() ) {
		$link = sprintf(
			...
			esc_url( jp_login_url( get_permalink() ) ),
			$args['login_text']
		);
	} else {
 ...
 * }
 * @param int|JP_Post $post    Optional. Post ID or JP_Post object the comment is going to be displayed on.
 *                             Default current post.
...
function get_post_reply_link( $args = array(), $post = null ) {
	 ...
	 * @param int|JP_Post $post      The post ID or JP_Post object.
	 */
 ...
 *           comment. See https://core.trac.jonpress.org/changeset/36512.
 *
 * @since 2.7.0
 *
 * @global JP_Comment $comment Current comment.
 *
 ...
 * }
 * @param array $comments Optional. Array of JP_Comment objects.
 */
function jp_list_comments( $args = array(), $comments = null ) {
	global $jp_query, $comment_alt, $comment_depth, $comment_thread_alt, $overridden_cpage, $in_comment_loop;
	 ...
	 * @since 4.0.0
	 *
	 * @see jp_list_comments()
	 *
	 * @param array $r An array of arguments for displaying comments.
	 */
	$r = apply_filters( 'jp_list_comments_args', $r );
	...
	if ( null !== $comments ) {
		...
		/*
		 * If 'page' or 'per_page' has been passed, and does not match what's in $jp_query,
		 * perform a separate comment query and allow Walker_Comment to paginate.
		 */
		if ( $r['page'] || $r['per_page'] ) {
			$current_cpage = get_query_var( 'cpage' );
			if ( ! $current_cpage ) {
				$current_cpage = 'newest' === get_option( 'default_comments_page' ) ? 1 : $jp_query->max_num_comment_pages;
			}
			...
			// Otherwise, fall back on the comments from `$jp_query->comments`.
		} else {
			if ( empty( $jp_query->comments ) ) {
				return;
			}
			if ( 'all' != $r['type'] ) {
				if ( empty( $jp_query->comments_by_type ) ) {
					$jp_query->comments_by_type = separate_comments( $jp_query->comments );
				}
				if ( empty( $jp_query->comments_by_type[ $r['type'] ] ) ) {
					return;
				}
				$_comments = $jp_query->comments_by_type[ $r['type'] ];
			} else {
				$_comments = $jp_query->comments;
			}

			if ( $jp_query->max_num_comment_pages ) {
	...
	jp_queue_comments_for_comment_meta_lazyload( $_comments );
 ...
 *     @type string $action               The comment form element action attribute. Default '/jp-comments-post.php'.
 ...
 * }
 * @param int|JP_Post $post_id Post ID or JP_Post object to generate the form for. Default current post.
 */
function comment_form( $args = array(), $post_id = null ) {
	...
	$fields   = array(
		...
		'cookies' => '<p class="comment-form-cookies-consent"><input id="jp-comment-cookies-consent" name="jp-comment-cookies-consent" type="checkbox" value="yes"' . $consent . ' />' .
					 '<label for="jp-comment-cookies-consent">' . __( 'Save my name, email, and website in this browser for the next time I comment.' ) . '</label></p>',
	);
	...
	$defaults = array(
		...
		/** This filter is documented in jp-includes/link-template.php */
		'must_log_in'          => '<p class="must-log-in">' . sprintf(
			/* translators: %s: login URL */
									__( 'You must be <a href="%s">logged in</a> to post a comment.' ),
			jp_login_url( apply_filters( 'the_permalink', get_permalink( $post_id ), $post_id ) )
		) . '</p>',
		/** This filter is documented in jp-includes/link-template.php */
		'logged_in_as'         => '<p class="logged-in-as">' . sprintf(
			...
			$user_identity,
			jp_logout_url( apply_filters( 'the_permalink', get_permalink( $post_id ), $post_id ) )
		) . '</p>',
		'comment_notes_before' => '<p class="comment-notes"><span id="email-notes">' . __( 'Your email address will not be published.' ) . '</span>' . ( $req ? $required_text : '' ) . '</p>',
		'comment_notes_after'  => '',
		'action'               => site_url( '/jp-comments-post.php' ),
		'id_form'              => 'commentform',
		'id_submit'            => 'submit',
	 ...
	 */
	$args = jp_parse_args( $args, apply_filters( 'comment_form_defaults', $defaults ) );
