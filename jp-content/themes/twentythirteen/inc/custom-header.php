 ...
 *
 * @link https://codex.jonpress.org/Custom_Headers
 *
 * @package JonPress
...
/**
 * Set up the JonPress core custom header arguments and settings.
 *
 * @uses add_theme_support() to register support for 3.4 and up.
 * @uses twentythirteen_header_style() to style front end.
 * @uses twentythirteen_admin_header_style() to style jp-admin form.
 * @uses twentythirteen_admin_header_image() to add custom markup to jp-admin form.
...
function twentythirteen_custom_header_setup() {
	$args = array(
		...
		'jp-head-callback'       => 'twentythirteen_header_style',
