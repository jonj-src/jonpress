<?php
/**
 * Dependencies API: JP_Dependencies base class
 *
 * @since 2.6.0
 *
 * @package JonPress
...
class JP_Dependencies {
	...
	/**
	 * An array of queued _JP_Dependency handle objects.
	 *
	 * @since 2.6.8
	 * @var array
	 */
	...
	/**
	 * An array of _JP_Dependency handle objects to queue.
	 *
	 * @since 2.6.0
	 * @var array
	 */
	...
	/**
	 * An array of _JP_Dependency handle objects already queued.
	 *
	 * @since 2.6.0
	 * @var array
	 */
	 ...
	 *
	 * @since 2.1.0
	 * @since 2.6.0 Moved from `JP_Scripts`.
	 * @since 2.8.0 Added the `$group` parameter.
	 *
	 ...
	 *
	 * @param string           $handle Name of the item. Should be unique.
	 * @param string           $src    Full URL of the item, or path of the item relative to the JonPress root directory.
	...
	public function add( $handle, $src, $deps = array(), $ver = false, $args = null ) {
		...
		$this->registered[ $handle ] = new _JP_Dependency( $handle, $src, $deps, $ver, $args );
		return true;
	}
	 ...
	 * @since 4.0.0
	 *
	 * @param string[] $queue  An array of queued _JP_Dependency handles.
	 * @param string   $handle Name of the item. Should be unique.
	 ...
	 * @return bool|_JP_Dependency Found, or object Item data.
	 */
