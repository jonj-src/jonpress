 ...
 */
function twentyfifteen_customize_register( $jp_customize ) {
	...
	$jp_customize->add_control(
		new JP_Customize_Color_Control(
			$jp_customize, 'sidebar_textcolor', array(
	...
	$jp_customize->add_control(
		new JP_Customize_Color_Control(
			$jp_customize, 'header_background_color', array(
	...
	$jp_customize->get_section( 'header_image' )->description = __( 'Applied to the header on small screens and the sidebar on wide screens.', 'twentyfifteen' );
}
...
function twentyfifteen_color_scheme_css() {
	...
	jp_add_inline_style( 'twentyfifteen-style', $color_scheme_css );
}
add_action( 'jp_enqueue_scripts', 'twentyfifteen_color_scheme_css' );
...
function twentyfifteen_customize_control_js() {
	jp_enqueue_script( 'color-scheme-control', get_template_directory_uri() . '/js/color-scheme-control.js', array( 'customize-controls', 'iris', 'underscore', 'jp-util' ), '20141216', true );
	jp_localize_script( 'color-scheme-control', 'colorScheme', twentyfifteen_get_color_schemes() );
}
...
function twentyfifteen_customize_preview_js() {
	jp_enqueue_script( 'twentyfifteen-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
