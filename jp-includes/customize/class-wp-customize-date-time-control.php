<?php
/**
 * Customize API: JP_Customize_Date_Time_Control class
 *
 * @package JonPress
 ...
 */
class JP_Customize_Date_Time_Control extends JP_Customize_Control {
	...
	public function content_template() {
		...
		<# _.defaults( data, <?php echo jp_json_encode( $data ); ?> ); #>
	...
	public function get_month_choices() {
		...
		$months = array();
		for ( $i = 1; $i < 13; $i++ ) {
			$month_text = $jp_locale->get_month_abbrev( $jp_locale->get_month( $i ) );
