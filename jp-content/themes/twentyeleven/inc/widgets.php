 ...
 */
class Twenty_Eleven_Ephemera_Widget extends JP_Widget {
	...
	function widget( $args, $instance ) {
		$cache = jp_cache_get( 'widget_twentyeleven_ephemera', 'widget' );
		...
		/** This filter is documented in jp-includes/default-widgets.php */
		...
		$ephemera      = new JP_Query( $ephemera_args );
...
?>
		...
		if ( ! is_customize_preview() ) {
			jp_cache_set( 'widget_twentyeleven_ephemera', $cache, 'widget' );
		}
	...
	function flush_widget_cache() {
		jp_cache_delete( 'widget_twentyeleven_ephemera', 'widget' );
	}
