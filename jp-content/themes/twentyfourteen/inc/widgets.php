 ...
 *
 * @link https://codex.jonpress.org/Widgets_API#Developing_Widgets
 *
 * @package JonPress
...
class Twenty_Fourteen_Ephemera_Widget extends JP_Widget {
	...
	public function __construct() {
		...
		if ( is_active_widget( false, false, $this->id_base ) || is_customize_preview() ) {
			add_action( 'jp_enqueue_scripts', array( $this, 'enqueue_scripts' ) );
		}
	}
	...
	public function enqueue_scripts() {
		...
		$audio_library = apply_filters( 'jp_audio_shortcode_library', 'mediaelement' );
		/** This filter is documented in jp-includes/media.php */
		$video_library = apply_filters( 'jp_video_shortcode_library', 'mediaelement' );
							...
							the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'twentyfourteen' ) );
								...
								if ( has_post_thumbnail() ) :
									...
									elseif ( $total_images > 0 ) :
										$image          = reset( $images );
										$post_thumbnail = jp_get_attachment_image( $image, 'post-thumbnail' );
									endif;
