<?php
/**
 * JonPress FTP Sockets Filesystem.
 *
 * @package JonPress
...
/**
 * JonPress Filesystem Class for implementing FTP Sockets.
 *
 * @since 2.5.0
 *
 * @see JP_Filesystem_Base
 */
class JP_Filesystem_ftpsockets extends JP_Filesystem_Base {
	/**
	 * @var ftp
	 */
	public $ftp;
	...
	public function __construct( $opt = '' ) {
		...
		if ( ! @include_once( ABSPATH . 'jp-admin/includes/class-ftp.php' ) ) {
			return;
		}
		$this->ftp = new ftp();
