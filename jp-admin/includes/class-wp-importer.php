...
class JP_Importer {
	...
	/**
	 * Returns array with imported permalinks from JonPress database
	 *
	...
	/**
	 * Return count of imported permalinks from JonPress database
	 *
	 * @global wpdb $wpdb JonPress database abstraction object.
	 *
	 * @param string $importer_name
	...
	/**
	 * Set array with imported comments from JonPress database
	 *
	 * @global wpdb $wpdb JonPress database abstraction object.
	 *
	 * @param string $bid
	...
	public function set_user( $user_id ) {
		...
		if ( ! $user_id || ! jp_set_current_user( $user_id ) ) {
	...
	public function get_page( $url, $username = '', $password = '', $head = false ) {
		...
		return jp_safe_remote_request( $url, $args );
	}
	 ...
	 *
	 * @global wpdb  $wpdb       JonPress database abstraction object.
	 * @global array $jp_actions
	 */
	public function stop_the_insanity() {
		global $wpdb, $jp_actions;
		// Or define( 'JP_IMPORTING', true );
		$wpdb->queries = array();
		// Reset $jp_actions to keep it from growing out of control
		$jp_actions = array();
	}
}
