<?php
/**
 * Widget API: JP_Widget_Media_Image class
 *
 * @package JonPress
 * @subpackage Widgets
 * @since 4.8.0
 ...
 * @see JP_Widget
 */
class JP_Widget_Media_Image extends JP_Widget_Media {
	...
	public function render_media( $instance ) {
		...
		if ( $attachment ) {
			...
			$image_attributes = array(
				'class' => sprintf( 'image jp-image-%d %s', $attachment->ID, $instance['image_classes'] ),
			...
			$image = jp_get_attachment_image( $attachment->ID, $size, false, $image_attributes );

			$caption_size = _jp_get_image_size_from_meta( $instance['size'], jp_get_attachment_metadata( $attachment->ID ) );
		...
		if ( 'file' === $instance['link_type'] ) {
			$url = $attachment ? jp_get_attachment_url( $attachment->ID ) : $instance['url'];
	...
	public function render_control_template_scripts() {
		...
		?>
		<script type="text/html" id="tmpl-jp-media-widget-image-fields">
		...
		<script type="text/html" id="tmpl-jp-media-widget-image-preview">
