...
$menu[4] = array( '', 'read', 'separator1', '', 'jp-menu-separator' );
...
$_jp_last_object_menu = 25; // The index of the last top-level menu in the object menu group
...
foreach ( array_merge( $builtin, $types ) as $ptype ) {
	...
	$ptype_menu_position = is_int( $ptype_obj->menu_position ) ? $ptype_obj->menu_position : ++$_jp_last_object_menu; // If we're to use $_jp_last_object_menu, increment it first.
...
$menu[59] = array( '', 'read', 'separator2', '', 'jp-menu-separator' );
...
$menu[60]                     = array( __( 'Appearance' ), $appearance_cap, 'themes.php', '', 'menu-top menu-icon-appearance', 'menu-appearance', 'dashicons-admin-appearance' );
	...
	$customize_url            = add_query_arg( 'return', urlencode( remove_query_arg( jp_removable_query_args(), jp_unslash( $_SERVER['REQUEST_URI'] ) ) ), 'customize.php' );
...
if ( current_user_can( 'list_users' ) ) {
	$_jp_real_parent_file['profile.php'] = 'users.php'; // Back-compat for plugins adding submenus to profile.php.
...
if ( ! is_multisite() && defined( 'JP_ALLOW_MULTISITE' ) && JP_ALLOW_MULTISITE ) {
...
$_jp_last_utility_menu = 80; // The index of the last top-level menu in the utility menu group

$menu[99] = array( '', 'read', 'separator-last', '', 'jp-menu-separator' );

// Back-compat for old top-levels
$_jp_real_parent_file['post.php']       = 'edit.php';
$_jp_real_parent_file['post-new.php']   = 'edit.php';
$_jp_real_parent_file['edit-pages.php'] = 'edit.php?post_type=page';
$_jp_real_parent_file['page-new.php']   = 'edit.php?post_type=page';
$_jp_real_parent_file['wpmu-admin.php'] = 'tools.php';
$_jp_real_parent_file['ms-admin.php']   = 'tools.php';
