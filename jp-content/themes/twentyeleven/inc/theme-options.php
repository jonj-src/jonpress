...
function twentyeleven_admin_enqueue_scripts( $hook_suffix ) {
	jp_enqueue_style( 'twentyeleven-theme-options', get_template_directory_uri() . '/inc/theme-options.css', false, '2011-04-28' );
	jp_enqueue_script( 'twentyeleven-theme-options', get_template_directory_uri() . '/inc/theme-options.js', array( 'farbtastic' ), '2011-06-10' );
	jp_enqueue_style( 'farbtastic' );
}
...
function twentyeleven_theme_options_help() {
	...
	$sidebar = '<p><strong>' . __( 'For more information:', 'twentyeleven' ) . '</strong></p>' .
		'<p>' . __( '<a href="https://codex.jonpress.org/Appearance_Theme_Options_Screen" target="_blank">Documentation on Theme Options</a>', 'twentyeleven' ) . '</p>' .
		'<p>' . __( '<a href="https://jonpress.org/support/" target="_blank">Support Forums</a>', 'twentyeleven' ) . '</p>';
...
function twentyeleven_theme_options_render_page() {
	...
	<div class="wrap">
		<?php screen_icon(); ?>
		<?php $theme_name = function_exists( 'jp_get_theme' ) ? jp_get_theme() : get_current_theme(); ?>
...
function twentyeleven_enqueue_color_scheme() {
	...
	if ( 'dark' == $color_scheme ) {
		jp_enqueue_style( 'dark', get_template_directory_uri() . '/colors/dark.css', array(), null );
	}
...
add_action( 'jp_enqueue_scripts', 'twentyeleven_enqueue_color_scheme' );

/**
 * Add a style block to the theme for the current link color.
 *
 * This function is attached to the jp_head action hook.
 *
 * @since Twenty Eleven 1.0
 */
...
add_action( 'jp_head', 'twentyeleven_print_link_color_style' );
 ...
 * @since Twenty Eleven 1.3
 *
 * @param object $jp_customize Customizer object.
 */
function twentyeleven_customize_register( $jp_customize ) {
...
function twentyeleven_customize_preview_js() {
	jp_enqueue_script( 'twentyeleven-customizer', get_template_directory_uri() . '/inc/theme-customizer.js', array( 'customize-preview' ), '20150401', true );
}
