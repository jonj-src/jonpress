 ...
 * already a JP_Http_Cookie() object, then they are turned into one.
 *
 * @todo The JonPress convention is to use underscores instead of camelCase for function and method
 * names. Need to switch to use underscores instead for the methods.
 *
 * @since 2.8.0
 */
class JP_Http_Cookie {
	...
	public function getHeaderValue() {
		 ...
		 */
		return $this->name . '=' . apply_filters( 'jp_http_cookie_value', $this->value, $this->name );
	}

	/**
	 * Retrieve cookie header for usage in the rest of the JonPress HTTP API.
	 *
	 * @since 2.8.0
	 *
	 * @return string
