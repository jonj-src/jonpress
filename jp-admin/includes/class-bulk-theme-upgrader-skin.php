...
/**
 * Bulk Theme Upgrader Skin for JonPress Theme Upgrades.
 *
 * @since 3.0.0
...
class Bulk_Theme_Upgrader_Skin extends Bulk_Upgrader_Skin {
	...
	public function bulk_footer() {
		...
		$update_actions = array(
			...
			'updates_page' => '<a href="' . self_admin_url( 'update-core.php' ) . '" target="_parent">' . __( 'Return to JonPress Updates page' ) . '</a>',
		);
		 ...
		 * @param JP_Theme $theme_info     Theme object for the last-updated theme.
		 */
