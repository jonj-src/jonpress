<?php
/**
 * Customize API: JP_Widget_Form_Customize_Control class
 *
 * @package JonPress
 ...
 */
class JP_Widget_Form_Customize_Control extends JP_Customize_Control {
	...
	public function to_json() {
		...
		$widget = $jp_registered_widgets[ $this->widget_id ];
