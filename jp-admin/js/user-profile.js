...
(function($) {
	...
	function bindToggleButton() {
		$toggleButton = $pass1Row.find('.jp-hide-pw');
	...
	function bindPasswordForm() {
		...
		$submitButton = $( '#submit, #jp-submit' ).on( 'click', function () {
			updateLock = false;
		});
		...
		$passwordWrapper = $pass1Row.find( '.jp-pwd' );
		$generateButton  = $pass1Row.find( 'button.jp-generate-pw' );
		...
		$cancelButton = $pass1Row.find( 'button.jp-cancel-pw' );
	...
	$(document).ready( function() {
		var $colorpicker, $stylesheet, user_id, current_user_id,
			...
			greeting     = $( '#jp-admin-bar-my-account' ).find( '.display-name' );
