<?php
/**
 * REST API: JP_REST_Response class
 *
 * @package JonPress
 * @subpackage REST_API
 * @since 4.4.0
 ...
 */
class JP_REST_Response extends JP_HTTP_Response {
	...
	public function remove_link( $rel, $href = null ) {
		...
		if ( $href ) {
			$this->links[ $rel ] = jp_list_filter( $this->links[ $rel ], array( 'href' => $href ), 'NOT' );
		} else {
			$this->links[ $rel ] = array();
		}
	...
	/**
	 * Retrieves a JP_Error object from the response.
	 *
	 * @since 4.4.0
	 *
	 * @return JP_Error|null JP_Error or null on not an errored response.
	 */
