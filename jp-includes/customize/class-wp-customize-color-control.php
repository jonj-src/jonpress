<?php
/**
 * Customize API: JP_Customize_Color_Control class
 *
 * @package JonPress
 ...
 */
class JP_Customize_Color_Control extends JP_Customize_Control {
	/**
	 * Type.
	 *
	 * @var string
	 ...
	 *
	 * @since 3.4.0
	 * @uses JP_Customize_Control::__construct()
	 *
	 ...
	 *
	 * @since 3.4.0
	 * @uses JP_Customize_Control::to_json()
	 */
