 ...
 *
 * @param JP_Customize_Manager $jp_customize Theme Customizer object.
 */
function twentyseventeen_customize_register( $jp_customize ) {
	...
	$jp_customize->add_control(
		new JP_Customize_Color_Control(
			$jp_customize, 'colorscheme_hue', array(
				'mode'     => 'hue',
				'section'  => 'colors',
				'priority' => 6,
			)
...
function twentyseventeen_customize_preview_js() {
	jp_enqueue_script( 'twentyseventeen-customize-preview', get_theme_file_uri( '/assets/js/customize-preview.js' ), array( 'customize-preview' ), '1.0', true );
}
...
function twentyseventeen_panels_js() {
	jp_enqueue_script( 'twentyseventeen-customize-controls', get_theme_file_uri( '/assets/js/customize-controls.js' ), array(), '1.0', true );
}
