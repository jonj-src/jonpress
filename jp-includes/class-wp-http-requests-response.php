<?php
/**
 * HTTP API: JP_HTTP_Requests_Response class
 *
 * @package JonPress
 * @subpackage HTTP
 * @since 4.6.0
 ...
 * @since 4.6.0
 *
 * @see JP_HTTP_Response
 */
class JP_HTTP_Requests_Response extends JP_HTTP_Response {
	/**
	 ...
	 * @since 4.6.0
	 *
	 * @return JP_HTTP_Cookie[] List of cookie objects.
	 */
	public function get_cookies() {
		$cookies = array();
		foreach ( $this->response->cookies as $cookie ) {
			$cookies[] = new JP_Http_Cookie(
				array(
					'name'    => $cookie->name,
	...
	/**
	 * Converts the object to a JP_Http response array.
	 *
	 * @since 4.6.0
	 *
	 * @return array JP_Http response array, per JP_Http::request().
	 */
