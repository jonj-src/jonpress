<?php
/**
 * JonPress Customize Manager classes
 *
 * @package JonPress
 ...
 * @since 3.4.0
 */
final class JP_Customize_Manager {
	/**
	 ...
	 *
	 * @since 4.5.0
	 * @var JP_Customize_Selective_Refresh
	 */
	public $selective_refresh;

	/**
	 * Registered instances of JP_Customize_Setting.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	/**
	 * Sorted top-level instances of JP_Customize_Panel and JP_Customize_Section.
	 *
	 * @since 4.0.0
	 * @var array
	 */
	...
	/**
	 * Registered instances of JP_Customize_Panel.
	 *
	 * @since 4.0.0
	 * @var array
	 */
	...
	/**
	 * Registered instances of JP_Customize_Section.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	/**
	 * Registered instances of JP_Customize_Control.
	 *
	 * @since 3.4.0
	 * @var array
	 */
	...
	public function __construct( $args = array() ) {
		...
		if ( ! isset( $args['changeset_uuid'] ) ) {
			$args['changeset_uuid'] = jp_generate_uuid4();
		}
		...
		if ( ! isset( $args['theme'] ) ) {
			if ( isset( $_REQUEST['customize_theme'] ) ) {
				$args['theme'] = jp_unslash( $_REQUEST['customize_theme'] );
			} elseif ( isset( $_REQUEST['theme'] ) ) { // Deprecated.
				$args['theme'] = jp_unslash( $_REQUEST['theme'] );
			}
		}
		if ( ! isset( $args['messenger_channel'] ) && isset( $_REQUEST['customize_messenger_channel'] ) ) {
			$args['messenger_channel'] = sanitize_key( jp_unslash( $_REQUEST['customize_messenger_channel'] ) );
		}

		$this->original_stylesheet = get_stylesheet();
		$this->theme               = jp_get_theme( 0 === validate_file( $args['theme'] ) ? $args['theme'] : null );
		...
		require_once( ABSPATH . WPINC . '/class-jp-customize-setting.php' );
		require_once( ABSPATH . WPINC . '/class-jp-customize-panel.php' );
		require_once( ABSPATH . WPINC . '/class-jp-customize-section.php' );
		require_once( ABSPATH . WPINC . '/class-jp-customize-control.php' );

		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-color-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-media-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-upload-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-image-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-background-image-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-background-position-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-cropped-image-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-site-icon-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-header-image-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-theme-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-code-editor-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-widget-area-customize-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-widget-form-customize-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-nav-menu-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-nav-menu-item-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-nav-menu-location-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-nav-menu-name-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-nav-menu-locations-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-nav-menu-auto-add-control.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-new-menu-control.php' ); // @todo Remove in 5.0. See #42364.

		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-nav-menus-panel.php' );

		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-themes-panel.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-themes-section.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-sidebar-section.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-nav-menu-section.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-new-menu-section.php' ); // @todo Remove in 5.0. See #42364.

		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-custom-css-setting.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-filter-setting.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-header-image-setting.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-background-image-setting.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-nav-menu-item-setting.php' );
		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-nav-menu-setting.php' );
		 ...
		 * @since 4.4.0
		 *
		 * @see JP_Customize_Manager::__construct()
		 *
		 * @param string[]             $components Array of core components to load.
		 * @param JP_Customize_Manager $this       JP_Customize_Manager instance.
		 */
		$components = apply_filters( 'customize_loaded_components', $this->components, $this );

		require_once( ABSPATH . WPINC . '/customize/class-jp-customize-selective-refresh.php' );
		$this->selective_refresh = new JP_Customize_Selective_Refresh( $this );

		if ( in_array( 'widgets', $components, true ) ) {
			require_once( ABSPATH . WPINC . '/class-jp-customize-widgets.php' );
			$this->widgets = new JP_Customize_Widgets( $this );
		}

		if ( in_array( 'nav_menus', $components, true ) ) {
			require_once( ABSPATH . WPINC . '/class-jp-customize-nav-menus.php' );
			$this->nav_menus = new JP_Customize_Nav_Menus( $this );
		}

		add_action( 'setup_theme', array( $this, 'setup_theme' ) );
		add_action( 'jp_loaded', array( $this, 'jp_loaded' ) );

		// Do not spawn cron (especially the alternate cron) while running the Customizer.
		remove_action( 'init', 'jp_cron' );
		...
		add_action( 'jp_ajax_customize_save', array( $this, 'save' ) );
		add_action( 'jp_ajax_customize_trash', array( $this, 'handle_changeset_trash_request' ) );
		add_action( 'jp_ajax_customize_refresh_nonces', array( $this, 'refresh_nonces' ) );
		add_action( 'jp_ajax_customize_load_themes', array( $this, 'handle_load_themes_request' ) );
		...
		add_action( 'jp_ajax_customize_override_changeset_lock', array( $this, 'handle_override_changeset_lock_request' ) );
		add_action( 'jp_ajax_customize_dismiss_autosave_or_lock', array( $this, 'handle_dismiss_autosave_or_lock_request' ) );
		...
		if ( current_user_can( 'install_themes' ) || current_user_can( 'update_themes' ) ) {
			...
			add_action( 'customize_controls_print_footer_scripts', 'jp_print_admin_notice_templates' );
		}
	}
	...
	public function doing_ajax( $action = null ) {
		...
		if ( ! $action ) {
			...
			/*
			 * Note: we can't just use doing_action( "jp_ajax_{$action}" ) because we need
			 * to check before admin-ajax.php gets to that point.
			 */
			return isset( $_REQUEST['action'] ) && jp_unslash( $_REQUEST['action'] ) === $action;
		}
	}

	/**
	 * Custom jp_die wrapper. Returns either the standard message for UI
	 * or the Ajax message.
	 *
	 * @since 3.4.0
	 *
	 ...
	 */
	protected function jp_die( $ajax_message, $message = null ) {
		if ( $this->doing_ajax() ) {
			jp_die( $ajax_message );
		}
		...
		if ( $this->messenger_channel ) {
			ob_start();
			jp_enqueue_scripts();
			jp_print_scripts( array( 'customize-base' ) );

			$settings = array(
				'messengerArgs' => array(
					'channel' => $this->messenger_channel,
					'url'     => jp_customize_url(),
				),
				'error'         => $ajax_message,
			);
			?>
			...
			} )( wp.customize, <?php echo jp_json_encode( $settings ); ?> );
			</script>
			<?php
	...
	/**
	 * Return the Ajax jp_die() handler if it's a customized request.
	 *
	 * @since 3.4.0
	 * @deprecated 4.7.0
	 *
	 ...
	 */
	public function jp_die_handler() {
		_deprecated_function( __METHOD__, '4.7.0' );

		if ( $this->doing_ajax() || isset( $_POST['customized'] ) ) {
			return '_ajax_jp_die_handler';
		}

		return '_default_jp_die_handler';
	}
	...
	public function setup_theme() {
		...
		if ( isset( $this->_changeset_uuid ) && false !== $this->_changeset_uuid && ! jp_is_uuid( $this->_changeset_uuid ) ) {
			$this->jp_die( -1, __( 'Invalid changeset UUID' ) );
		}

		/*
		 * Clear incoming post data if the user lacks a CSRF token (nonce). Note that the customizer
		 * application will inject the customize_preview_nonce query parameter into all Ajax requests.
		 * For similar behavior elsewhere in JonPress, see rest_cookie_check_errors() which logs out
		...
		if ( ! current_user_can( 'customize' ) && ! $this->changeset_post_id() ) {
			$this->jp_die( $this->messenger_channel ? 0 : -1, __( 'Non-existent changeset UUID.' ) );
		}
		...
		if ( $this->is_theme_active() ) {
			...
			if ( ! current_user_can( 'switch_themes' ) ) {
				$this->jp_die( -1, __( 'Sorry, you are not allowed to edit theme options on this site.' ) );
			}

			// If the theme has errors while loading, bail.
			if ( $this->theme()->errors() ) {
				$this->jp_die( -1, $this->theme()->errors()->get_error_message() );
			}

			// If the theme isn't allowed per multisite settings, bail.
			if ( ! $this->theme()->is_allowed() ) {
				$this->jp_die( -1, __( 'The requested theme does not exist.' ) );
			}
		}
	...
	public function establish_loaded_changeset() {
		...
		if ( empty( $this->_changeset_uuid ) ) {
			...
			if ( ! $this->branching() && $this->is_theme_active() ) {
				...
				if ( ! empty( $unpublished_changeset_post ) && jp_is_uuid( $unpublished_changeset_post->post_name ) ) {
			...
			if ( empty( $changeset_uuid ) ) {
				$changeset_uuid = jp_generate_uuid4();
			}
	...
	public function after_setup_theme() {
		...
		if ( ! $doing_ajax_or_is_customized && ! validate_current_theme() ) {
			jp_redirect( 'themes.php?broken=true' );
			exit;
		}
	}
	...
	public function start_previewing_theme() {
		...
		if ( ! $this->is_theme_active() ) {
			...
			// @link: https://core.trac.jonpress.org/ticket/20027
	 ...
	 *
	 * @since 4.9.0
	 * @see JP_Customize_Setting::preview()
	 *
	 * @return bool
	 */
	 ...
	 *
	 * @since 4.9.0
	 * @see JP_Customize_Manager::changeset_data()
	 *
	 ...
	 *
	 * @since 4.9.0
	 * @see JP_Customize_Manager::establish_loaded_changeset()
	 *
	...
	public function branching() {
		 ...
		 *
		 * Since linear changesets are deemed to be more suitable for the majority of JonPress users,
		 * they are the default. For JonPress sites that have heavy site management in the Customizer
		 ...
		 * @param JP_Customize_Manager $jp_customize    Manager instance.
		 */
	...
	public function jp_loaded() {
		...
		$this->register_panel_type( 'JP_Customize_Panel' );
		$this->register_panel_type( 'JP_Customize_Themes_Panel' );
		$this->register_section_type( 'JP_Customize_Section' );
		$this->register_section_type( 'JP_Customize_Sidebar_Section' );
		$this->register_section_type( 'JP_Customize_Themes_Section' );
		$this->register_control_type( 'JP_Customize_Color_Control' );
		$this->register_control_type( 'JP_Customize_Media_Control' );
		$this->register_control_type( 'JP_Customize_Upload_Control' );
		$this->register_control_type( 'JP_Customize_Image_Control' );
		$this->register_control_type( 'JP_Customize_Background_Image_Control' );
		$this->register_control_type( 'JP_Customize_Background_Position_Control' );
		$this->register_control_type( 'JP_Customize_Cropped_Image_Control' );
		$this->register_control_type( 'JP_Customize_Site_Icon_Control' );
		$this->register_control_type( 'JP_Customize_Theme_Control' );
		$this->register_control_type( 'JP_Customize_Code_Editor_Control' );
		$this->register_control_type( 'JP_Customize_Date_Time_Control' );

		/**
		 * Fires once JonPress has loaded, allowing scripts and styles to be initialized.
		 *
		 * @since 3.4.0
		 *
		 * @param JP_Customize_Manager $this JP_Customize_Manager instance.
	 ...
	 * @return int
	 */
	public function jp_redirect_status( $status ) {
	...
	public function find_changeset_post_id( $uuid ) {
		...
		if ( ! empty( $changeset_post_query->posts ) ) {
			...
			jp_cache_set( $uuid, $changeset_post_id, $cache_group );
			return $changeset_post_id;
		}
	 ...
	 * }
	 * @return JP_Post[] Auto-draft changesets.
	 */
	...
	protected function get_changeset_post_data( $post_id ) {
		...
		if ( function_exists( 'json_last_error' ) && json_last_error() ) {
			return new JP_Error( 'json_parse_error', '', json_last_error() );
		}
		if ( ! is_array( $changeset_data ) ) {
			return new JP_Error( 'expected_array' );
		}
	...
	public function changeset_data() {
		...
		if ( ! $changeset_post_id ) {
			...
			if ( $this->autosaved() && is_user_logged_in() ) {
				$autosave_post = jp_get_post_autosave( $changeset_post_id, get_current_user_id() );
				if ( $autosave_post ) {
	...
	function import_theme_starter_content( $starter_content = array() ) {
		...
		$all_post_slugs = array_merge(
			jp_list_pluck( $attachments, 'post_name' ),
			jp_list_pluck( $posts, 'post_name' )
		);
		 ...
		 */
		$post_types = array_filter( array_merge( array( 'attachment' ), jp_list_pluck( $posts, 'post_type' ) ) );

		// Re-use auto-draft starter content posts referenced in the current customized state.
		$existing_starter_content_posts = array();
		if ( ! empty( $starter_content_auto_draft_post_ids ) ) {
			$existing_posts_query = new JP_Query(
				array(
			...
			foreach ( $attachments as $symbol => $attachment ) {
				...
				if ( isset( $existing_starter_content_posts[ 'attachment:' . $attachment['post_name'] ] ) ) {
					...
					if ( empty( $attached_file ) || ! file_exists( $attached_file ) ) {
						...
						$metadata = jp_generate_attachment_metadata( $attachment_post->ID, $attached_file );
						jp_update_attachment_metadata( $attachment_id, $metadata );
				...
				if ( ! $attachment_id ) {
					...
					$temp_file_name = jp_tempnam( basename( $file_path ) );
					...
					$attachment_post_data = array_merge(
						jp_array_slice_assoc( $attachment, array( 'post_title', 'post_content', 'post_excerpt' ) ),
						array(
		...
		if ( ! empty( $posts ) ) {
			foreach ( array_keys( $posts ) as $post_symbol ) {
				...
				if ( ! empty( $posts[ $post_symbol ]['template'] ) ) {
					$posts[ $post_symbol ]['meta_input']['_jp_page_template'] = $posts[ $post_symbol ]['template'];
				}

				$r = $this->nav_menus->insert_auto_draft_post( $posts[ $post_symbol ] );
				if ( $r instanceof JP_Post ) {
					$posts[ $post_symbol ]['ID'] = $r->ID;
				}
			}

			$starter_content_auto_draft_post_ids = array_merge( $starter_content_auto_draft_post_ids, jp_list_pluck( $posts, 'ID' ) );
		}
		...
		foreach ( $theme_mods as $name => $value ) {
			...
			if ( 'header_image' === $name ) {
				...
				$metadata = jp_get_attachment_metadata( $value );
				if ( empty( $metadata ) ) {
					continue;
				}
				$value = array(
					'attachment_id' => $value,
					'url'           => jp_get_attachment_url( $value ),
					'height'        => $metadata['height'],
					'width'         => $metadata['width'],
				);
			} elseif ( 'background_image' === $name ) {
				$value = jp_get_attachment_url( $value );
			}
	...
	protected function prepare_starter_content_attachments( $attachments ) {
		...
		foreach ( $attachments as $symbol => $attachment ) {
			...
			$checked_filetype = jp_check_filetype( $file_name );
	 ...
	 * 4. Any programmatically-set post values via `JP_Customize_Manager::set_post_value()`.
	 *
	...
	public function unsanitized_post_values( $args = array() ) {
		...
		if ( ! $this->is_theme_active() ) {
			...
			if ( isset( $stashed_theme_mods[ $stylesheet ] ) ) {
				$values = array_merge( $values, jp_list_pluck( $stashed_theme_mods[ $stylesheet ], 'value' ) );
			}
		}
		...
		if ( ! $args['exclude_post_data'] ) {
			if ( ! isset( $this->_post_values ) ) {
				if ( isset( $_POST['customized'] ) ) {
					$post_values = json_decode( jp_unslash( $_POST['customized'] ), true );
				} else {
					$post_values = array();
				}
	 ...
	 *
	 * @see JP_REST_Server::dispatch()
	 * @see JP_REST_Request::sanitize_params()
	 * @see JP_REST_Request::has_valid_params()
	 *
	 * @param JP_Customize_Setting $setting A JP_Customize_Setting derived object.
	...
	public function post_value( $setting, $default = null ) {
		...
		if ( is_jp_error( $valid ) ) {
			return $default;
		}
		$value = $setting->sanitize( $value );
		if ( is_null( $value ) || is_jp_error( $value ) ) {
			return $default;
		}
		return $value;
	}
	 ...
	 * @since 4.2.0
	 *
	 * @param string $setting_id ID for the JP_Customize_Setting instance.
	...
	public function set_post_value( $setting_id, $value ) {
		 ...
		 *
		 * Fires when the JP_Customize_Manager::set_post_value() method is called.
		 *
		 ...
		 * Fires when the JP_Customize_Manager::set_post_value() method is called.
		 *
		 * This is useful for `JP_Customize_Setting` instances to watch
	...
	public function customize_preview_init() {
		 ...
		 * allowed then the auth cookies would not be sent and JonPress would
		...
		add_action( 'jp_head', 'jp_no_robots' );
		add_filter( 'jp_headers', array( $this, 'filter_iframe_security_headers' ) );
		...
		if ( $this->messenger_channel && ! current_user_can( 'customize' ) ) {
			$this->jp_die( -1, __( 'Unauthorized. You may remove the customize_messenger_channel param to preview as frontend.' ) );
			return;
		}

		$this->prepare_controls();

		add_filter( 'jp_redirect', array( $this, 'add_state_query_params' ) );

		jp_enqueue_script( 'customize-preview' );
		jp_enqueue_style( 'customize-preview' );
		add_action( 'jp_head', array( $this, 'customize_preview_loading_style' ) );
		add_action( 'jp_head', array( $this, 'remove_frameless_preview_messenger_channel' ) );
		add_action( 'jp_footer', array( $this, 'customize_preview_settings' ), 20 );
	 ...
	 * @since 4.7.0
	 * @see jp_redirect()
	 * @see JP_Customize_Manager::get_allowed_url()
	 *
	 * @param string $url URL.
	 * @return string URL.
	 */
	public function add_state_query_params( $url ) {
		$parsed_original_url = jp_parse_url( $url );
		$is_allowed          = false;
		foreach ( $this->get_allowed_urls() as $allowed_url ) {
			$parsed_allowed_url = jp_parse_url( $allowed_url );
			$is_allowed         = (
	...
	public function customize_preview_settings() {
		...
		$self_url           = empty( $_SERVER['REQUEST_URI'] ) ? home_url( '/' ) : esc_url_raw( jp_unslash( $_SERVER['REQUEST_URI'] ) );
		...
		foreach ( $allowed_urls as $allowed_url ) {
			$parsed = jp_parse_url( $allowed_url );
		...
		<script type="text/javascript">
			var _wpCustomizeSettings = <?php echo jp_json_encode( $settings ); ?>;
				...
				foreach ( $this->settings as $id => $setting ) {
					if ( $setting->check_capabilities() ) {
						printf(
							"v[%s] = %s;\n",
							jp_json_encode( $id ),
							jp_json_encode( $setting->js_value() )
						);
					}
				}
				?>
	 ...
	 * @deprecated 4.7.0
	 *
	 * @param mixed $return Value passed through for {@see 'jp_die_handler'} filter.
	 * @return mixed Value passed through for {@see 'jp_die_handler'} filter.
	 */
	 ...
	 * to values that pass validation, and values that become null or `JP_Error`
	 * after sanitizing are marked invalid.
	 *
	 * @since 4.6.0
	 *
	 * @see JP_REST_Request::has_valid_params()
	 * @see JP_Customize_Setting::validate()
	 *
	 ...
	 * }
	 * @return array Mapping of setting IDs to return value of validate method calls, either `true` or `JP_Error`.
	 */
	public function validate_setting_values( $setting_values, $options = array() ) {
		$options = jp_parse_args(
			$options, array(
		...
		foreach ( $setting_values as $setting_id => $unsanitized_value ) {
			...
			if ( ! $setting ) {
				if ( $options['validate_existence'] ) {
					$validities[ $setting_id ] = new JP_Error( 'unrecognized', __( 'Setting does not exist or is unrecognized.' ) );
				}
				continue;
			}
			if ( $options['validate_capability'] && ! current_user_can( $setting->capability ) ) {
				$validity = new JP_Error( 'unauthorized', __( 'Unauthorized to modify setting due to capability.' ) );
			} else {
			...
			if ( ! is_jp_error( $validity ) ) {
				/** This filter is documented in jp-includes/class-jp-customize-setting.php */
				$late_validity = apply_filters( "customize_validate_{$setting->id}", new JP_Error(), $unsanitized_value, $setting );
			...
			if ( ! is_jp_error( $validity ) ) {
				...
				if ( is_null( $value ) ) {
					$validity = false;
				} elseif ( is_jp_error( $value ) ) {
					$validity = $value;
				}
			}
			if ( false === $validity ) {
				$validity = new JP_Error( 'invalid_value', __( 'Invalid value.' ) );
			}
	 ...
	 *
	 * Converts `JP_Error` instance into array suitable for passing into the
	 * `wp.customize.Notification` JS model.
	 *
	 * @since 4.6.0
	 *
	 * @param true|JP_Error $validity Setting validity.
	 * @return true|array If `$validity` was a JP_Error, the error codes will be array-mapped
	...
	public function save() {
		if ( ! is_user_logged_in() ) {
			jp_send_json_error( 'unauthenticated' );
		}

		if ( ! $this->is_preview() ) {
			jp_send_json_error( 'not_preview' );
		}

		$action = 'save-customize_' . $this->get_stylesheet();
		if ( ! check_ajax_referer( $action, 'nonce', false ) ) {
			jp_send_json_error( 'invalid_nonce' );
		}
		...
		if ( $is_new_changeset ) {
			if ( ! current_user_can( get_post_type_object( 'customize_changeset' )->cap->create_posts ) ) {
				jp_send_json_error( 'cannot_create_changeset_post' );
			}
		} else {
			if ( ! current_user_can( get_post_type_object( 'customize_changeset' )->cap->edit_post, $changeset_post_id ) ) {
				jp_send_json_error( 'cannot_edit_changeset_post' );
			}
		}

		if ( ! empty( $_POST['customize_changeset_data'] ) ) {
			$input_changeset_data = json_decode( jp_unslash( $_POST['customize_changeset_data'] ), true );
			if ( ! is_array( $input_changeset_data ) ) {
				jp_send_json_error( 'invalid_customize_changeset_data' );
			}
		} else {
		...
		if ( isset( $_POST['customize_changeset_title'] ) ) {
			$changeset_title = sanitize_text_field( jp_unslash( $_POST['customize_changeset_title'] ) );
		}
		...
		if ( isset( $_POST['customize_changeset_status'] ) ) {
			$changeset_status = jp_unslash( $_POST['customize_changeset_status'] );
			if ( ! get_post_status_object( $changeset_status ) || ! in_array( $changeset_status, array( 'draft', 'pending', 'publish', 'future' ), true ) ) {
				jp_send_json_error( 'bad_customize_changeset_status', 400 );
			}
			...
			if ( $is_publish && ! current_user_can( get_post_type_object( 'customize_changeset' )->cap->publish_posts ) ) {
				jp_send_json_error( 'changeset_publish_unauthorized', 403 );
			}
		}
		...
		if ( isset( $_POST['customize_changeset_date'] ) ) {
			$changeset_date = jp_unslash( $_POST['customize_changeset_date'] );
			if ( preg_match( '/^\d\d\d\d-\d\d-\d\d \d\d:\d\d:\d\d$/', $changeset_date ) ) {
				...
				$valid_date = jp_checkdate( $mm, $jj, $aa, $changeset_date );
				if ( ! $valid_date ) {
					jp_send_json_error( 'bad_customize_changeset_date', 400 );
				}
		...
		if ( ! $is_new_changeset ) {
			$lock_user_id = jp_check_post_lock( $this->changeset_post_id() );
		}
		...
		if ( is_jp_error( $r ) ) {
			...
			if ( 'publish' === $response['changeset_status'] || 'trash' === $response['changeset_status'] ) {
				$response['next_changeset_uuid'] = jp_generate_uuid4();
			}
		}
		...
		if ( is_jp_error( $r ) ) {
			jp_send_json_error( $response );
		} else {
			jp_send_json_success( $response );
		}
	}
	 ...
	 * }
	 *
	 * @return array|JP_Error Returns array on success and JP_Error with array data on error.
	 */
	function save_changeset_post( $args = array() ) {
		...
		if ( $changeset_post_id ) {
			...
			if ( 'publish' === $existing_status || 'trash' === $existing_status ) {
				return new JP_Error(
					...
					array(
						'next_changeset_uuid' => jp_generate_uuid4(),
					)
				);
			}

			$existing_changeset_data = $this->get_changeset_post_data( $changeset_post_id );
			if ( is_jp_error( $existing_changeset_data ) ) {
				return $existing_changeset_data;
			}
		}

		// Fail if attempting to publish but publish hook is missing.
		if ( 'publish' === $args['status'] && false === has_action( 'transition_post_status', '_jp_customize_publish_changeset' ) ) {
			return new JP_Error( 'missing_publish_callback' );
		}
		...
		if ( $args['date_gmt'] ) {
			...
			if ( ! $is_future_dated ) {
				return new JP_Error( 'not_future_date', __( 'You must supply a future date to schedule.' ) ); // Only future dates are allowed.
			}

			if ( ! $this->is_theme_active() && ( 'future' === $args['status'] || $is_future_dated ) ) {
				return new JP_Error( 'cannot_schedule_theme_switches' ); // This should be allowed in the future, when theme is a regular setting.
			}
			...
			if ( $will_remain_auto_draft ) {
				return new JP_Error( 'cannot_supply_date_for_auto_draft_changeset' );
			}
			...
			if ( mysql2date( 'U', $changeset_post->post_date_gmt, false ) <= mysql2date( 'U', $now, false ) ) {
				return new JP_Error( 'not_future_date', __( 'You must supply a future date to schedule.' ) );
			}
		}
		...
		// Validate autosave param. See _jp_post_revision_fields() for why these fields are disallowed.
		if ( $args['autosave'] ) {
			if ( $args['date_gmt'] ) {
				return new JP_Error( 'illegal_autosave_with_date_gmt' );
			} elseif ( $args['status'] ) {
				return new JP_Error( 'illegal_autosave_with_status' );
			} elseif ( $args['user_id'] && get_current_user_id() !== $args['user_id'] ) {
				return new JP_Error( 'illegal_autosave_with_non_current_user' );
			}
		}
		...
		$invalid_setting_count = count( array_filter( $setting_validities, 'is_jp_error' ) );
		...
		if ( $update_transactionally && $invalid_setting_count > 0 ) {
			...
			return new JP_Error( 'transaction_fail', '', $response );
		}
		...
		foreach ( $args['data'] as $setting_id => $setting_params ) {
			...
			if ( isset( $setting_validities[ $setting_id ] ) && is_jp_error( $setting_validities[ $setting_id ] ) ) {
				continue;
			}
		...
		$filter_context = array(
			...
			'previous_data' => is_jp_error( $original_changeset_data ) ? array() : $original_changeset_data,
			'manager'       => $this,
		);
		 ...
		 *     @type JP_Customize_Manager $manager       Manager instance.
		 * }
		 */
		...
		// Gather the data for jp_insert_post()/jp_update_post().
		$json_options = 0;
		...
		$post_array    = array(
			'post_content' => jp_json_encode( $data, $json_options ),
		);
		if ( $args['title'] ) {
		...
		add_filter( 'jp_save_post_revision_post_has_changed', array( $this, '_filter_revision_post_has_changed' ), 5, 3 );

		// Update the changeset post. The publish_customize_changeset action will cause the settings in the changeset to be saved via JP_Customize_Setting::save().
		$has_kses = ( false !== has_filter( 'content_save_pre', 'jp_filter_post_kses' ) );
		if ( $has_kses ) {
			kses_remove_filters(); // Prevent KSES from corrupting JSON in post_content.
		}

		// Note that updating a post with publish status will trigger JP_Customize_Manager::publish_changeset_values().
		if ( $changeset_post_id ) {
			if ( $args['autosave'] && 'auto-draft' !== get_post_status( $changeset_post_id ) ) {
				// See _jp_translate_postdata() for why this is required as it will use the edit_post meta capability.
				add_filter( 'map_meta_cap', array( $this, 'grant_edit_post_capability_for_changeset' ), 10, 4 );
				$post_array['post_ID']   = $post_array['ID'];
				$post_array['post_type'] = 'customize_changeset';
				$r                       = jp_create_post_autosave( jp_slash( $post_array ) );
				...
				$r                       = jp_update_post( jp_slash( $post_array ), true );

				// Delete autosave revision for user when the changeset is updated.
				if ( ! empty( $args['user_id'] ) ) {
					$autosave_draft = jp_get_post_autosave( $changeset_post_id, $args['user_id'] );
					if ( $autosave_draft ) {
						jp_delete_post( $autosave_draft->ID, true );
					}
				}
			}
		} else {
			$r = jp_insert_post( jp_slash( $post_array ), true );
			if ( ! is_jp_error( $r ) ) {
		...
		$this->_changeset_data = null; // Reset so JP_Customize_Manager::changeset_data() will re-populate with updated contents.

		remove_filter( 'jp_save_post_revision_post_has_changed', array( $this, '_filter_revision_post_has_changed' ) );
		...
		if ( is_jp_error( $r ) ) {
			...
			return new JP_Error( 'changeset_post_save_failure', '', $response );
		}
	 ...
	 *
	 * The following re-formulates the logic from `jp_trash_post()` as done in
	 * `jp_publish_post()`. The reason for bypassing `jp_trash_post()` is that it
	 ...
	 * @see jp_trash_post()
	 *
	 * @param int|JP_Post $post The changeset post.
	 * @return mixed A JP_Post object for the trashed post or an empty value on failure.
	 */
	public function trash_changeset_post( $post ) {
		...
		if ( ! ( $post instanceof JP_Post ) ) {
			return $post;
		}
		$post_id = $post->ID;

		if ( ! EMPTY_TRASH_DAYS ) {
			return jp_delete_post( $post_id, true );
		}
		...
		/** This filter is documented in jp-includes/post.php */
		$check = apply_filters( 'pre_trash_post', null, $post );
		if ( null !== $check ) {
			return $check;
		}

		/** This action is documented in jp-includes/post.php */
		do_action( 'jp_trash_post', $post_id );

		add_post_meta( $post_id, '_jp_trash_meta_status', $post->post_status );
		add_post_meta( $post_id, '_jp_trash_meta_time', time() );
		...
		jp_transition_post_status( $new_status, $old_status, $post );
		...
		/** This action is documented in jp-includes/post.php */
		do_action( 'jp_insert_post', $post->ID, $post, true );

		jp_trash_post_comments( $post_id );
	 ...
	 * required in core for `jp_create_post_autosave()` because it will call
	 * `_jp_translate_postdata()` which in turn will check if a user can 'edit_post', but the
	 ...
	 *
	 * @since 4.9.0
	 * @link https://core.trac.jonpress.org/ticket/40922
	 * @see JP_Customize_Manager::save_changeset_post()
	 * @see _jp_translate_postdata()
	 *
	...
	public function check_changeset_lock_with_heartbeat( $response, $data, $screen_id ) {
		...
		if (
			...
			$lock_user_id = jp_check_post_lock( $changeset_post_id );
	...
	public function handle_override_changeset_lock_request() {
		if ( ! $this->is_preview() ) {
			jp_send_json_error( 'not_preview', 400 );
		}
		...
		jp_send_json_success( 'changeset_taken_over' );
	}
	 ...
	 * @param JP_Post $last_revision    The last revision post object.
	 * @param JP_Post $post             The post object.
	 *
	 ...
	 * `_jp_customize_publish_changeset()` when a customize_changeset post is
	 * transitioned to the `publish` status. As such, this method should not be
	 * called directly and instead `jp_publish_post()` should be used.
	 *
	 ...
	 *
	 * @since 4.7.0
	 * @see _jp_customize_publish_changeset()
	 * @global wpdb $wpdb
	 *
	 * @param int $changeset_post_id ID for customize_changeset post. Defaults to the changeset for the current manager instance.
	 * @return true|JP_Error True or error info.
	 */
	public function _publish_changeset_values( $changeset_post_id ) {
		...
		if ( is_jp_error( $publishing_changeset_data ) ) {
		 ...
		 * on the $jp_customize object passed to hooks during the save logic.
		 */
		 ...
		 * @since 3.4.0
		 *
		 * @param JP_Customize_Manager $manager JP_Customize_Manager instance.
		 */
		...
		foreach ( $changeset_setting_ids as $setting_id ) {
			...
			if ( $setting ) {
				...
				if ( isset( $setting_user_ids[ $setting_id ] ) ) {
					jp_set_current_user( $setting_user_ids[ $setting_id ] );
				} else {
					jp_set_current_user( $original_user_id );
				}
		 ...
		 */
		$revisions = jp_get_post_revisions( $changeset_post_id, array( 'check_enabled' => false ) );
	...
	public function refresh_nonces() {
		...
		jp_send_json_success( $this->get_nonces() );
	}
	...
	public function handle_dismiss_autosave_or_lock_request() {
		// Calls to dismiss_user_auto_draft_changesets() and jp_get_post_autosave() require non-zero get_current_user_id().
		if ( ! is_user_logged_in() ) {
			jp_send_json_error( 'unauthenticated', 401 );
		}
		...
		if ( ! check_ajax_referer( 'customize_dismiss_autosave_or_lock', 'nonce', false ) ) {
			jp_send_json_error( 'invalid_nonce', 403 );
		}
		...
		if ( $dismiss_autosave ) {
			if ( empty( $changeset_post_id ) || 'auto-draft' === get_post_status( $changeset_post_id ) ) {
				...
				if ( $dismissed > 0 ) {
					jp_send_json_success( 'auto_draft_dismissed' );
				} else {
					jp_send_json_error( 'no_auto_draft_to_delete', 404 );
				}
			} else {
				$revision = jp_get_post_autosave( $changeset_post_id, get_current_user_id() );

				if ( $revision ) {
					if ( ! current_user_can( get_post_type_object( 'customize_changeset' )->cap->delete_post, $changeset_post_id ) ) {
						jp_send_json_error( 'cannot_delete_autosave_revision', 403 );
					}

					if ( ! jp_delete_post( $revision->ID, true ) ) {
						jp_send_json_error( 'autosave_revision_deletion_failure', 500 );
					} else {
						jp_send_json_success( 'autosave_revision_deleted' );
					}
				} else {
					jp_send_json_error( 'no_autosave_revision_to_delete', 404 );
				}
			}
		}

		jp_send_json_error( 'unknown_error', 500 );
	}
	 ...
	 *
	 * @since 3.4.0
	 * @since 4.5.0 Return added JP_Customize_Setting instance.
	 *
	 * @param JP_Customize_Setting|string $id   Customize Setting object, or ID.
	 * @param array                       $args {
	 *  Optional. Array of properties for the new JP_Customize_Setting. Default empty array.
	 *
	 ...
	 * @link https://developer.jonpress.org/themes/customize-api
	 *                                            Default is 'refresh'
	 ...
	 * }
	 * @return JP_Customize_Setting             The instance of the setting that was added.
	 */
	public function add_setting( $id, $args = array() ) {
		if ( $id instanceof JP_Customize_Setting ) {
			$setting = $id;
		} else {
			$class = 'JP_Customize_Setting';

			/** This filter is documented in jp-includes/class-jp-customize-manager.php */
	 ...
	 * on the front end and have been sent to JonPress in `$_POST['customized']`. When WP
	 ...
	 * @return array The JP_Customize_Setting objects added.
	 */
	public function add_dynamic_settings( $setting_ids ) {
		...
		foreach ( $setting_ids as $setting_id ) {
			...
			$setting_args  = false;
			$setting_class = 'JP_Customize_Setting';
			 ...
			 * the JP_Customize_Setting constructor.
			 *
			 * @since 4.2.0
			 *
			 * @param false|array $setting_args The arguments to the JP_Customize_Setting constructor.
			...
			/**
			 * Allow non-statically created settings to be constructed with custom JP_Customize_Setting subclass.
			 *
			 * @since 4.2.0
			 *
			 * @param string $setting_class JP_Customize_Setting or a subclass.
			 * @param string $setting_id    ID for dynamic setting, usually coming from `$_POST['customized']`.
			 * @param array  $setting_args  JP_Customize_Setting or a subclass.
			 */
	 ...
	 * @return JP_Customize_Setting|void The setting, if set.
	 */
	 ...
	 *
	 * @since 4.0.0
	 * @since 4.5.0 Return added JP_Customize_Panel instance.
	 *
	 * @param JP_Customize_Panel|string $id   Customize Panel object, or Panel ID.
	 * @param array                     $args {
	 ...
	 * }
	 * @return JP_Customize_Panel             The instance of the panel that was added.
	 */
	public function add_panel( $id, $args = array() ) {
		if ( $id instanceof JP_Customize_Panel ) {
			$panel = $id;
		} else {
			$panel = new JP_Customize_Panel( $this, $id, $args );
		}
	 ...
	 * @return JP_Customize_Panel|void Requested panel instance, if set.
	 */
	...
	public function remove_panel( $id ) {
		...
		if ( in_array( $id, $this->components, true ) ) {
			...
			$message = sprintf(
				...
				$id,
				'<a href="' . esc_url( 'https://developer.jonpress.org/reference/hooks/customize_loaded_components/' ) . '"><code>customize_loaded_components</code></a>'
			);
	 ...
	 * @since 4.3.0
	 *
	 * @see JP_Customize_Panel
	 *
	 * @param string $panel Name of a custom panel which is a subclass of JP_Customize_Panel.
	 */
	 ...
	 *
	 * @since 3.4.0
	 * @since 4.5.0 Return added JP_Customize_Section instance.
	 *
	 * @param JP_Customize_Section|string $id   Customize Section object, or Section ID.
	 * @param array                     $args {
	 ...
	 * }
	 * @return JP_Customize_Section             The instance of the section that was added.
	 */
	public function add_section( $id, $args = array() ) {
		if ( $id instanceof JP_Customize_Section ) {
			$section = $id;
		} else {
			$section = new JP_Customize_Section( $this, $id, $args );
		}
	 ...
	 * @return JP_Customize_Section|void The section, if set.
	 */
	 ...
	 * @since 4.3.0
	 *
	 * @see JP_Customize_Section
	 *
	 * @param string $section Name of a custom section which is a subclass of JP_Customize_Section.
	 */
	 ...
	 *
	 * @since 3.4.0
	 * @since 4.5.0 Return added JP_Customize_Control instance.
	 *
	 * @param JP_Customize_Control|string $id   Customize Control object, or ID.
	 * @param array                       $args {
	 ...
	 *                                            IDs in the array correspond to the ID of a registered `JP_Customize_Setting`.
	 ...
	 * }
	 * @return JP_Customize_Control             The instance of the control that was added.
	 */
	public function add_control( $id, $args = array() ) {
		if ( $id instanceof JP_Customize_Control ) {
			$control = $id;
		} else {
			$control = new JP_Customize_Control( $this, $id, $args );
		}
	 ...
	 * @return JP_Customize_Control|void The control object, if set.
	 */
				...
				<div class="notification-message customize-changeset-locked-message">
					...
					<p class="action-buttons">
						...
						<# if ( data.allowOverride ) { #>
							<button class="button button-primary jp-tab-last customize-notice-take-over-button"><?php _e( 'Take over' ); ?></button>
						<# } #>
					</p>
				</div>
			</li>
	 ...
	 *
	 * @since 3.4.0
	 * @deprecated 4.7.0 Use jp_list_sort()
	 *
	 * @param JP_Customize_Panel|JP_Customize_Section|JP_Customize_Control $a Object A.
	 * @param JP_Customize_Panel|JP_Customize_Section|JP_Customize_Control $b Object B.
	 * @return int
	 */
	protected function _cmp_priority( $a, $b ) {
		_deprecated_function( __METHOD__, '4.7.0', 'jp_list_sort' );
	...
	public function enqueue_control_scripts() {
		...
		if ( ! is_multisite() && ( current_user_can( 'install_themes' ) || current_user_can( 'update_themes' ) || current_user_can( 'delete_themes' ) ) ) {
			jp_enqueue_script( 'updates' );
			jp_localize_script(
				'updates', '_wpUpdatesItemCounts', array(
					'totals' => jp_get_update_data(),
				)
			);
		}
	}
	...
	public function is_ios() {
		return jp_is_mobile() && preg_match( '/iPad|iPod|iPhone/', $_SERVER['HTTP_USER_AGENT'] );
	}
	...
	public function set_preview_url( $preview_url ) {
		...
		$this->preview_url = jp_validate_redirect( $preview_url, home_url( '/' ) );
	}
	...
	public function is_cross_domain() {
		$admin_origin = jp_parse_url( admin_url() );
		$home_origin  = jp_parse_url( home_url() );
	...
	public function set_return_url( $return_url ) {
		...
		$return_url       = remove_query_arg( jp_removable_query_args(), $return_url );
		$return_url       = jp_validate_redirect( $return_url );
	...
	public function get_return_url() {
		$referer                    = jp_get_referer();
		$excluded_referer_basenames = array( 'customize.php', 'jp-login.php' );
	...
	public function set_autofocus( $autofocus ) {
		$this->autofocus = array_filter( jp_array_slice_assoc( $autofocus, array( 'panel', 'section', 'control' ) ), 'is_string' );
	}
	...
	public function get_nonces() {
		$nonces = array(
			'save'                     => jp_create_nonce( 'save-customize_' . $this->get_stylesheet() ),
			'preview'                  => jp_create_nonce( 'preview-customize_' . $this->get_stylesheet() ),
			'switch_themes'            => jp_create_nonce( 'switch_themes' ),
			'dismiss_autosave_or_lock' => jp_create_nonce( 'customize_dismiss_autosave_or_lock' ),
			'override_lock'            => jp_create_nonce( 'customize_override_changeset_lock' ),
			'trash'                    => jp_create_nonce( 'trash_customize_changeset' ),
		);
	...
	public function customize_pane_settings() {
		...
		if ( ! $this->saved_starter_content_changeset && ! $this->autosaved() ) {
			if ( $changeset_post_id ) {
				if ( is_user_logged_in() ) {
					$autosave_revision_post = jp_get_post_autosave( $changeset_post_id, get_current_user_id() );
				}
			} else {
		...
		<script type="text/javascript">
			...
			foreach ( $this->settings() as $setting ) {
				if ( $setting->check_capabilities() ) {
					printf(
						"s[%s] = %s;\n",
						jp_json_encode( $setting->id ),
						jp_json_encode( $setting->json() )
					);
				}
			}
			...
			foreach ( $this->controls() as $control ) {
				if ( $control->check_capabilities() ) {
					printf(
						"c[%s] = %s;\n",
						jp_json_encode( $control->id ),
						jp_json_encode( $control->json() )
					);
				}
			}
	...
	public function get_previewable_devices() {
		 ...
		 * @since 4.5.0
		 *
		 * @see JP_Customize_Manager::get_previewable_devices()
		 *
	...
	public function register_controls() {
		...
		$this->add_panel(
			new JP_Customize_Themes_Panel(
				$this, 'themes', array(
					'title'       => $this->theme()->display( 'Name' ),
					'description' => (
					'<p>' . __( 'Looking for a theme? You can search or browse the JonPress.org theme directory, install and preview themes, then activate them right here.' ) . '</p>' .
		...
		$this->add_section(
			new JP_Customize_Themes_Section(
		...
		$this->add_setting(
			new JP_Customize_Filter_Setting(
		...
		$this->add_control(
			new JP_Customize_Site_Icon_Control(
				$this, 'site_icon', array(
					'label'       => __( 'Site Icon' ),
					'description' => sprintf(
						'<p>' . __( 'Site Icons are what you see in browser tabs, bookmark bars, and within the JonPress mobile apps. Upload one here!' ) . '</p>' .
		...
		$this->add_control(
			new JP_Customize_Cropped_Image_Control(
		...
		$this->add_control(
			new JP_Customize_Color_Control(
		...
		$this->add_setting(
			new JP_Customize_Header_Image_Setting(
		...
		$this->add_control(
			new JP_Customize_Media_Control(
		...
		$this->add_control( new JP_Customize_Header_Image_Control( $this ) );

		$this->selective_refresh->add_partial(
			'custom_header', array(
				'selector'            => '#jp-custom-header',
		...
		$this->add_setting(
			new JP_Customize_Background_Image_Setting(
		...
		$this->add_control( new JP_Customize_Background_Image_Control( $this ) );
		...
		$this->add_control(
			new JP_Customize_Background_Position_Control(
		...
		if ( get_theme_support( 'custom-background', 'jp-head-callback' ) === '_custom_background_cb' ) {
		...
		/*
		 * Static Front Page
		 * See also https://core.trac.jonpress.org/ticket/19627 which introduces the static-front-page theme_support.
		...
		$section_description .= sprintf(
			...
			esc_url( __( 'https://codex.jonpress.org/CSS' ) ),
		...
		if ( 'false' !== jp_get_current_user()->syntax_highlighting ) {
			$section_description .= '<p>';
			$section_description .= sprintf(
		...
		$custom_css_setting = new JP_Customize_Custom_CSS_Setting(
		...
		$this->add_control(
			new JP_Customize_Code_Editor_Control(
	...
	public function handle_load_themes_request() {
		...
		if ( empty( $_POST['theme_action'] ) ) {
			jp_send_json_error( 'missing_theme_action' );
		}
		...
		if ( ! array_key_exists( 'search', $_POST ) ) {
			...
			$args['search'] = sanitize_text_field( jp_unslash( $_POST['search'] ) );
		}

		if ( ! array_key_exists( 'tags', $_POST ) ) {
			$args['tag'] = '';
		} else {
			$args['tag'] = array_map( 'sanitize_text_field', jp_unslash( (array) $_POST['tags'] ) );
		}
		...
		if ( 'installed' === $theme_action ) {
			...
			// Load all installed themes from jp_prepare_themes_for_js().
			$themes = array( 'themes' => jp_prepare_themes_for_js() );
			...
			// Load JonPress.org themes from the .org API and normalize data to match installed theme objects.
			...
			if ( is_jp_error( $themes ) ) {
				jp_send_json_error();
			}

			// This list matches the allowed tags in jp-admin/includes/theme-install.php.
			...
			$jp_themes        = jp_get_themes();
			foreach ( $jp_themes as $theme ) {
				$installed_themes[] = $theme->get_stylesheet();
			}
			$update_php = network_admin_url( 'update.php?action=install-theme' );

			// Set up properties for themes available on JonPress.org.
			foreach ( $themes->themes as &$theme ) {
				$theme->install_url = add_query_arg(
					array(
						'theme'    => $theme->slug,
						'_wpnonce' => jp_create_nonce( 'install-theme_' . $theme->slug ),
					), $update_php
				);

				$theme->name        = jp_kses( $theme->name, $themes_allowedtags );
				$theme->version     = jp_kses( $theme->version, $themes_allowedtags );
				$theme->description = jp_kses( $theme->description, $themes_allowedtags );
				$theme->stars       = jp_star_rating(
					array(
						'rating' => $theme->rating,
						'type'   => 'percent',
				...
				$theme->authorAndUri = jp_kses( $theme->author['display_name'], $themes_allowedtags );
		 ...
		 * or modification of data loaded from `jp_prepare_themes_for_js()`
		 * or JonPress.org via `themes_api()`.
		 *
		 * @since 4.9.0
		 *
		 * @see jp_prepare_themes_for_js()
		 * @see themes_api()
		 * @see JP_Customize_Manager::__construct()
		 *
		 * @param array                $themes  Nested array of theme data.
		 * @param array                $args    List of arguments, such as page, search term, and tags to query for.
		 * @param JP_Customize_Manager $manager Instance of Customize manager.
		 */
		$themes = apply_filters( 'customize_load_themes', $themes, $args, $this );

		jp_send_json_success( $themes );
	}
	 ...
	 * @param JP_Customize_Setting $setting Setting.
	 * @return string|JP_Error Background value or validation error.
	 */
	public function _sanitize_background_setting( $value, $setting ) {
		if ( 'background_repeat' === $setting->id ) {
			if ( ! in_array( $value, array( 'repeat-x', 'repeat-y', 'repeat', 'no-repeat' ) ) ) {
				return new JP_Error( 'invalid_value', __( 'Invalid value for background repeat.' ) );
			}
		} elseif ( 'background_attachment' === $setting->id ) {
			if ( ! in_array( $value, array( 'fixed', 'scroll' ) ) ) {
				return new JP_Error( 'invalid_value', __( 'Invalid value for background attachment.' ) );
			}
		} elseif ( 'background_position_x' === $setting->id ) {
			if ( ! in_array( $value, array( 'left', 'center', 'right' ), true ) ) {
				return new JP_Error( 'invalid_value', __( 'Invalid value for background position X.' ) );
			}
		} elseif ( 'background_position_y' === $setting->id ) {
			if ( ! in_array( $value, array( 'top', 'center', 'bottom' ), true ) ) {
				return new JP_Error( 'invalid_value', __( 'Invalid value for background position Y.' ) );
			}
		} elseif ( 'background_size' === $setting->id ) {
			if ( ! in_array( $value, array( 'auto', 'contain', 'cover' ), true ) ) {
				return new JP_Error( 'invalid_value', __( 'Invalid value for background size.' ) );
			}
			...
			return new JP_Error( 'unrecognized_setting', __( 'Unrecognized background setting.' ) );
		}
		return $value;
	}
	 ...
	 * @param JP_Customize_Selective_Refresh $selective_refresh Selective refresh component.
	 ...
	 *
	 * @see JP_Customize_Manager::register_controls()
	 *
	 * @since 4.5.0
	 *
