...
(function( component, $ ) {
	 ...
	 * Image widget model.
	 *
	 * See JP_Widget_Media_Image::enqueue_admin_scripts() for amending prototype from PHP exports.
	 *
	...
	ImageWidgetControl = component.MediaWidgetControl.extend(/** @lends wp.mediaWidgets.controlConstructors.media_image.prototype */{
		...
		renderPreview: function renderPreview() {
			...
			previewTemplate = wp.template( 'jp-media-widget-image-preview' );
			...
			if ( ! linkInput.is( document.activeElement ) ) {
				...
				fieldsTemplate = wp.template( 'jp-media-widget-image-fields' );
		...
		editMedia: function editMedia() {
			...
			// Disable syncing of attachment changes back to server. See <https://core.trac.jonpress.org/ticket/40403>.
