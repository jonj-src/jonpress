...
( function ( wp, $ ) {
	...
	function addContainer( ariaLive ) {
		...
		var $container = $( '<div>', {
			'id': 'jp-a11y-speak-' + ariaLive,
			'aria-live': ariaLive,
			'aria-relevant': 'additions text',
			'aria-atomic': 'true',
			'class': 'screen-reader-text jp-a11y-speak-region'
		});
	...
	$( document ).ready( function() {
		$containerPolite = $( '#jp-a11y-speak-polite' );
		$containerAssertive = $( '#jp-a11y-speak-assertive' );
