...
if ( 'category' == $taxonomy ) {
	 ...
	 *
	 * @param JP_Term $tag Current category term object.
	 */
	 ...
	 * @deprecated 3.0.0 Use {$taxonomy}_pre_edit_form instead.
	 *
	 * @param JP_Term $tag Current link category term object.
	 */
	 ...
	 * @deprecated 3.0.0 Use {$taxonomy}_pre_edit_form instead.
	 *
	 * @param JP_Term $tag Current tag term object.
	 */
	do_action( 'edit_tag_form_pre', $tag );
}

/**
 * Use with caution, see https://codex.jonpress.org/Function_Reference/jp_reset_vars
 */
jp_reset_vars( array( 'jp_http_referer' ) );

$jp_http_referer = remove_query_arg( array( 'action', 'message', 'tag_ID' ), $jp_http_referer );
 ...
 * @since 3.0.0
 *
 * @param JP_Term $tag      Current taxonomy term object.
...
<div id="message" class="updated">
	...
	<p><a href="<?php echo esc_url( jp_validate_redirect( esc_url_raw( $jp_http_referer ), admin_url( 'term.php?taxonomy=' . $taxonomy ) ) ); ?>">
							<?php
...
jp_nonce_field( 'update-tag_' . $tag_ID );
...
<?php if ( ! global_terms_enabled() ) { ?>
		<tr class="form-field term-slug-wrap">
			 ...
			 * @param JP_Term|JP_Post $tag  Term or JP_Post object.
			 */
...
<?php if ( is_taxonomy_hierarchical( $taxonomy ) ) : ?>
		<tr class="form-field term-parent-wrap">
			...
			<td>
				...
				/** This filter is documented in jp-admin/edit-tags.php */
...
// Back compat hooks
if ( 'category' == $taxonomy ) {
	/** This action is documented in jp-admin/edit-tags.php */
...
<div class="edit-tag-actions">
	...
	<?php if ( current_user_can( 'delete_term', $tag->term_id ) ) : ?>
		<span id="delete-link">
			<a class="delete" href="<?php echo admin_url( jp_nonce_url( "edit-tags.php?action=delete&taxonomy=$taxonomy&tag_ID=$tag->term_id", 'delete-tag_' . $tag->term_id ) ); ?>"><?php _e( 'Delete' ); ?></a>
		</span>
	<?php endif; ?>
