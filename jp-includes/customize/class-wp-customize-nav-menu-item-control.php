<?php
/**
 * Customize API: JP_Customize_Nav_Menu_Item_Control class
 *
 * @package JonPress
 ...
 * @since 4.3.0
 */
class JP_Customize_Nav_Menu_Item_Control extends JP_Customize_Control {
	 ...
	 *
	 * @since 4.3.0
	 * @var JP_Customize_Nav_Menu_Item_Setting
	 */
	public $setting;
	 ...
	 * @since 4.3.0
	 *
	 * @see JP_Customize_Control::__construct()
	 *
