...
/**
 * Theme Upgrader Skin for JonPress Theme Upgrades.
 *
 * @since 2.8.0
 ...
 */
class Theme_Upgrader_Skin extends JP_Upgrader_Skin {
	public $theme = '';
	...
	public function after() {
		...
		if ( ! empty( $this->upgrader->result['destination_name'] ) && $theme_info = $this->upgrader->theme_info() ) {
			...
			if ( ! $this->result || is_jp_error( $this->result ) || is_network_admin() ) {
