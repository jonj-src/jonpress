...
jp_enqueue_script( 'plupload-handlers' );
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.jonpress.org/Media_Add_New_Screen">Documentation on Uploading Media Files</a>' ) . '</p>' .
