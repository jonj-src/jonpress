<?php
/**
 * Deprecated functions from past JonPress versions. You shouldn't use these
...
/**
 * Sets up the JonPress Loop.
 *
 * Use The Loop instead.
 *
 * @link https://codex.jonpress.org/The_Loop
 *
 * @since 1.0.1
 * @deprecated 1.5.0
 */
function start_wp() {
	...
	_deprecated_function( __FUNCTION__, '1.5.0', __('new JonPress Loop') );
 ...
 *
 * @since 1.0.1
 * @deprecated 2.1.0 Use jp_list_bookmarks()
 * @see jp_list_bookmarks()
 *
 * @param string $category The category to use.
 * @param string $args
 * @return string|null
 */
function jp_get_linksbyname($category, $args = '') {
	_deprecated_function(__FUNCTION__, '2.1.0', 'jp_list_bookmarks()');
 ...
 *
 * @since 0.71
 * @deprecated 2.1.0 Use jp_list_categories()
 * @see jp_list_categories()
 *
 * @param int $optionall
 * @param string $all
...
function list_cats($optionall = 1, $all = 'All', $sort_column = 'ID', $sort_order = 'asc', $file = '', $list = true, $optiondates = 0,
	...
	_deprecated_function( __FUNCTION__, '2.1.0', 'jp_list_categories()' );

	$query = compact('optionall', 'all', 'sort_column', 'sort_order', 'file', 'list', 'optiondates', 'optioncount', 'hide_empty', 'use_desc_for_title', 'children',
		'child_of', 'categories', 'recurse', 'feed', 'feed_image', 'exclude', 'hierarchical');
	return jp_list_cats($query);
}
 ...
 */
function jp_list_cats($args = '') {
	_deprecated_function( __FUNCTION__, '2.1.0', 'jp_list_categories()' );

	$r = jp_parse_args( $args );
 ...
 *
 * @since 0.71
 * @deprecated 2.1.0 Use jp_dropdown_categories()
 * @see jp_dropdown_categories()
 *
 * @param int $optionall
 * @param string $all
...
function dropdown_cats($optionall = 1, $all = 'All', $orderby = 'ID', $order = 'asc',
	...
	_deprecated_function( __FUNCTION__, '2.1.0', 'jp_dropdown_categories()' );
	...
	return jp_dropdown_categories($query);
}
 ...
 *
 * @since 1.2.0
 * @deprecated 2.1.0 Use jp_list_authors()
 * @see jp_list_authors()
 *
...
function list_authors($optioncount = false, $exclude_admin = true, $show_fullname = false, $hide_empty = true, $feed = '', $feed_image = '') {
	_deprecated_function( __FUNCTION__, '2.1.0', 'jp_list_authors()' );

	$args = compact('optioncount', 'exclude_admin', 'show_fullname', 'hide_empty', 'feed', 'feed_image');
	return jp_list_authors($args);
}
 ...
 *
 * @since 1.0.1
 * @deprecated 2.1.0 Use jp_get_post_categories()
 * @see jp_get_post_categories()
 *
 * @param int $blogid Not Used
 * @param int $post_ID
 * @return array
 */
function jp_get_post_cats($blogid = '1', $post_ID = 0) {
	_deprecated_function( __FUNCTION__, '2.1.0', 'jp_get_post_categories()' );
	return jp_get_post_categories($post_ID);
}
 ...
 * @since 1.0.1
 * @deprecated 2.1.0
 * @deprecated Use jp_set_post_categories()
 * @see jp_set_post_categories()
 *
 * @param int $blogid Not used
 * @param int $post_ID
 ...
 * @return bool|mixed
 */
function jp_set_post_cats($blogid = '1', $post_ID = 0, $post_categories = array()) {
	_deprecated_function( __FUNCTION__, '2.1.0', 'jp_set_post_categories()' );
	return jp_set_post_categories($post_ID, $post_categories);
}
 ...
 *
 * @since 0.71
 * @deprecated 2.1.0 Use jp_get_archives()
 * @see jp_get_archives()
 *
 * @param string $type
 * @param string $limit
...
function get_archives($type='', $limit='', $format='html', $before = '', $after = '', $show_post_count = false) {
	_deprecated_function( __FUNCTION__, '2.1.0', 'jp_get_archives()' );
	$args = compact('type', 'limit', 'format', 'before', 'after', 'show_post_count');
	return jp_get_archives($args);
}
 ...
 *
 * @since 0.71
 * @deprecated 2.1.0 Use jp_link_pages()
 * @see jp_link_pages()
 *
 * @param string $before
 * @param string $after
...
function link_pages($before='<br />', $after='<br />', $next_or_number='number', $nextpagelink='next page', $previouspagelink='previous page',
					$pagelink='%', $more_file='') {
	_deprecated_function( __FUNCTION__, '2.1.0', 'jp_link_pages()' );

	$args = compact('before', 'after', 'next_or_number', 'nextpagelink', 'previouspagelink', 'pagelink', 'more_file');
	return jp_link_pages($args);
}
...
/**
 * An alias of jp_create_user().
 *
 * @since 2.0.0
 * @deprecated 2.0.0 Use jp_create_user()
 * @see jp_create_user()
 *
...
function create_user($username, $password, $email) {
	_deprecated_function( __FUNCTION__, '2.0.0', 'jp_create_user()' );
	return jp_create_user($username, $password, $email);
}
 ...
 * @see get_terms()
 *
 * @link https://codex.jonpress.org/Function_Reference/get_all_category_ids
 *
...
function get_all_category_ids() {
	...
	if ( ! $cat_ids = jp_cache_get( 'all_category_ids', 'category' ) ) {
		$cat_ids = get_terms( 'category', array('fields' => 'ids', 'get' => 'all') );
		jp_cache_add( 'all_category_ids', $cat_ids, 'category' );
	}
 ...
 *
 * @since 1.0.0
 * @deprecated 3.0.0 Use jp_load_alloptions())
 * @see jp_load_alloptions()
 *
 * @return array List of all options.
 */
function get_alloptions() {
	_deprecated_function( __FUNCTION__, '3.0.0', 'jp_load_alloptions()' );
	return jp_load_alloptions();
}
 ...
 *
 * @since 2.0.0
 * @deprecated 2.5.0 Use jp_get_attachment_link()
 * @see jp_get_attachment_link()
 *
...
function get_the_attachment_link($id = 0, $fullsize = false, $max_dims = false, $permalink = false) {
	_deprecated_function( __FUNCTION__, '2.5.0', 'jp_get_attachment_link()' );
	$id = (int) $id;
	$_post = get_post($id);

	if ( ('attachment' != $_post->post_type) || !$url = jp_get_attachment_url($_post->ID) )
 ...
 *
 * @since 2.1.0
 * @deprecated 2.5.0 Use jp_get_attachment_image_src()
 * @see jp_get_attachment_image_src()
 *
 * @param int $id Optional. Post ID.
...
function get_attachment_icon_src( $id = 0, $fullsize = false ) {
	_deprecated_function( __FUNCTION__, '2.5.0', 'jp_get_attachment_image_src()' );
	$id = (int) $id;
	if ( !$post = get_post($id) )
		return false;
	...
	if ( !$fullsize && $src = jp_get_attachment_thumb_url( $post->ID ) ) {
		// We have a thumbnail desired, specified and existing

		$src_file = basename($src);
	} elseif ( jp_attachment_is_image( $post->ID ) ) {
		// We have an image without a thumbnail

		$src = jp_get_attachment_url( $post->ID );
		$src_file = & $file;
	} elseif ( $src = jp_mime_type_icon( $post->ID ) ) {
 ...
 *
 * @since 2.0.0
 * @deprecated 2.5.0 Use jp_get_attachment_image()
 * @see jp_get_attachment_image()
 *
 * @param int $id Optional. Post ID.
...
function get_attachment_icon( $id = 0, $fullsize = false, $max_dims = false ) {
	_deprecated_function( __FUNCTION__, '2.5.0', 'jp_get_attachment_image()' );
	$id = (int) $id;
	if ( !$post = get_post($id) )
		return false;
 ...
 */
function jp_specialchars( $string, $quote_style = ENT_NOQUOTES, $charset = false, $double_encode = false ) {
	_deprecated_function( __FUNCTION__, '2.8.0', 'esc_html()' );
	if ( func_num_args() > 1 ) { // Maintain back-compat for people passing additional arguments.
		$args = func_get_args();
		return call_user_func_array( '_jp_specialchars', $args );
	} else {
 ...
 *
 * Passes to jp_register_sidebar_widget() after argument list and backward
 * compatibility is complete.
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use jp_register_sidebar_widget()
 * @see jp_register_sidebar_widget()
 *
...
function register_sidebar_widget($name, $output_callback, $classname = '') {
	_deprecated_function( __FUNCTION__, '2.8.0', 'jp_register_sidebar_widget()' );
	// Compat
	if ( is_array($name) ) {
		if ( count($name) == 3 )
	...
	call_user_func_array('jp_register_sidebar_widget', $args);
}

/**
 * Serves as an alias of jp_unregister_sidebar_widget().
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use jp_unregister_sidebar_widget()
 * @see jp_unregister_sidebar_widget()
 *
 * @param int|string $id Widget ID.
 */
function unregister_sidebar_widget($id) {
	_deprecated_function( __FUNCTION__, '2.8.0', 'jp_unregister_sidebar_widget()' );
	return jp_unregister_sidebar_widget($id);
}
 ...
 * the array for the name.
 *
 * Passes to jp_register_widget_control() after the argument list has
 * been compiled.
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use jp_register_widget_control()
 * @see jp_register_widget_control()
 *
...
function register_widget_control($name, $control_callback, $width = '', $height = '') {
	_deprecated_function( __FUNCTION__, '2.8.0', 'jp_register_widget_control()' );
	// Compat
	if ( is_array($name) ) {
		if ( count($name) == 3 )
			$name = sprintf($name[0], $name[2]);
	...
	call_user_func_array('jp_register_widget_control', $args);
}

/**
 * Alias of jp_unregister_widget_control().
 *
 * @since 2.2.0
 * @deprecated 2.8.0 Use jp_unregister_widget_control()
 * @see jp_unregister_widget_control()
 *
 * @param int|string $id Widget ID.
 */
function unregister_widget_control($id) {
	_deprecated_function( __FUNCTION__, '2.8.0', 'jp_unregister_widget_control()' );
	return jp_unregister_widget_control($id);
}
...
function delete_usermeta( $user_id, $meta_key, $meta_value = '' ) {
	...
	jp_cache_delete( $user_id, 'user_meta' );
...
function get_usermeta( $user_id, $meta_key = '' ) {
	...
	if ( !empty($meta_key) ) {
		$meta_key = preg_replace('|[^a-z0-9_]|i', '', $meta_key);
		$user = jp_cache_get($user_id, 'users');
...
function automatic_feed_links( $add = true ) {
	...
	if ( $add )
		...
		remove_action( 'jp_head', 'feed_links_extra', 3 ); // Just do this yourself in 3.0+
}
 ...
 * @return bool
 */
function jp_timezone_supported() {
 ...
 *
 * @since 2.1.0
 * @deprecated 3.3.0 Use jp_editor()
 * @see jp_editor()
 *
...
function the_editor($content, $id = 'content', $prev_id = 'title', $media_buttons = true, $tab_index = 2, $extended = true) {
	_deprecated_function( __FUNCTION__, '3.3.0', 'jp_editor()' );

	jp_editor( $content, $id, array( 'media_buttons' => $media_buttons ) );
}
 ...
 * @deprecated 3.3.0
 *
 * @param JP_Admin_Bar $jp_admin_bar JP_Admin_Bar instance.
 */
function jp_admin_bar_dashboard_view_site_menu( $jp_admin_bar ) {
	_deprecated_function( __FUNCTION__, '3.3.0' );
	...
	if ( 0 != $user_id ) {
		if ( is_admin() )
			$jp_admin_bar->add_menu( array( 'id' => 'view-site', 'title' => __( 'Visit Site' ), 'href' => home_url() ) );
		elseif ( is_multisite() )
			$jp_admin_bar->add_menu( array( 'id' => 'dashboard', 'title' => __( 'Dashboard' ), 'href' => get_dashboard_url( $user_id ) ) );
		else
			$jp_admin_bar->add_menu( array( 'id' => 'dashboard', 'title' => __( 'Dashboard' ), 'href' => admin_url() ) );
	}
}
 ...
 *
 * @since 1.5.0
 * @deprecated 3.4.0 Use jp_get_themes()
 * @see jp_get_themes()
 *
 * @return array Theme list with theme data.
 */
function get_themes() {
	_deprecated_function( __FUNCTION__, '3.4.0', 'jp_get_themes()' );
	...
	foreach ( $themes as $theme ) {
		$name = $theme->get('Name');
		if ( isset( $jp_themes[ $name ] ) )
			$jp_themes[ $name . '/' . $theme->get_stylesheet() ] = $theme;
		else
			$jp_themes[ $name ] = $theme;
	}
 ...
 *
 * @since 1.5.0
 * @deprecated 3.4.0 Use jp_get_theme()
 * @see jp_get_theme()
 *
...
function get_theme( $theme ) {
	_deprecated_function( __FUNCTION__, '3.4.0', 'jp_get_theme( $stylesheet )' );
...
function get_current_theme() {
	_deprecated_function( __FUNCTION__, '3.4.0', 'jp_get_theme()' );

	if ( $theme = get_option( 'current_theme' ) )
		return $theme;

	return jp_get_theme()->get('Name');
}
 ...
 * @see add_theme_support()
 *
 * @param callable $jp_head_callback Call on the {@see 'jp_head'} action.
 ...
 */
function add_custom_image_header( $jp_head_callback, $admin_head_callback, $admin_preview_callback = '' ) {
	_deprecated_function( __FUNCTION__, '3.4.0', 'add_theme_support( \'custom-header\', $args )' );
	$args = array(
		'jp-head-callback'    => $jp_head_callback,
 ...
 */
function add_custom_background( $jp_head_callback = '', $admin_head_callback = '', $admin_preview_callback = '' ) {
	_deprecated_function( __FUNCTION__, '3.4.0', 'add_theme_support( \'custom-background\', $args )' );
	$args = array();
	if ( $jp_head_callback )
		$args['jp-head-callback'] = $jp_head_callback;
...
function get_theme_data( $theme_file ) {
	_deprecated_function( __FUNCTION__, '3.4.0', 'jp_get_theme()' );
	$theme = new JP_Theme( basename( dirname( $theme_file ) ), dirname( dirname( $theme_file ) ) );
 ...
 *
 * @since 2.0.4
 * @deprecated 3.4.1 Use jp_nonce_ays()
 * @see jp_nonce_ays()
 *
 * @param string $action Nonce action.
 * @return string Are you sure message.
 */
function jp_explain_nonce( $action ) {
	_deprecated_function( __FUNCTION__, '3.4.1', 'jp_nonce_ays()' );
 ...
 *
 * This is no longer needed as JP_Post lazy-loads the ancestors
 ...
 *
 * @param JP_Post $post Post object, passed by reference (unused).
 */
 ...
 *
 * @since 2.1.0
 * @deprecated 3.5.0 Use jp_get_image_editor()
 * @see jp_get_image_editor()
 *
 * @param string $file Filename of the image to load.
 * @return resource The resulting image resource on success, Error string on failure.
 */
function jp_load_image( $file ) {
	_deprecated_function( __FUNCTION__, '3.5.0', 'jp_get_image_editor()' );
 ...
 * support. This is not the fault of JonPress (where functionality is
 ...
 * @return mixed JP_Error on failure. String with new destination path.
 */
function image_resize( $file, $max_w, $max_h, $crop = false, $suffix = null, $dest_path = null, $jpeg_quality = 90 ) {
	_deprecated_function( __FUNCTION__, '3.5.0', 'jp_get_image_editor()' );

	$editor = jp_get_image_editor( $file );
	if ( is_jp_error( $editor ) )
		return $editor;
	$editor->set_quality( $jpeg_quality );

	$resized = $editor->resize( $max_w, $max_h, $crop );
	if ( is_jp_error( $resized ) )
		return $resized;
 ...
 * @return JP_Post|null Post object or array holding post contents and information
 */
function jp_get_single_post( $postid = 0, $mode = OBJECT ) {
 ...
 *
 * @since 0.71
 * @deprecated 3.5.0 Use jp_authenticate()
 * @see jp_authenticate()
 *
...
function user_pass_ok($user_login, $user_pass) {
	_deprecated_function( __FUNCTION__, '3.5.0', 'jp_authenticate()' );
	$user = jp_authenticate( $user_login, $user_pass );
	if ( is_jp_error( $user ) )
		return false;
 ...
 *
 * @since 2.9.0
 * @deprecated 3.5.0 Use jp_image_editor_supports()
 * @see jp_image_editor_supports()
 *
 * @param string $mime_type
 * @return bool
 */
function gd_edit_image_support($mime_type) {
	_deprecated_function( __FUNCTION__, '3.5.0', 'jp_image_editor_supports()' );
 ...
 */
function jp_convert_bytes_to_hr( $bytes ) {
...
function rich_edit_exists() {
	global $jp_rich_edit_exists;
	_deprecated_function( __FUNCTION__, '3.9.0' );

	if ( ! isset( $jp_rich_edit_exists ) )
		$jp_rich_edit_exists = file_exists( ABSPATH . WPINC . '/js/tinymce/tinymce.js' );

	return $jp_rich_edit_exists;
}
 ...
 *
 * Determines if the URL can be accessed over SSL by using the JonPress HTTP API to access
...
function url_is_accessable_via_ssl( $url ) {
	...
	$response = jp_remote_get( set_url_scheme( $url, 'https' ) );

	if ( !is_jp_error( $response ) ) {
		$status = jp_remote_retrieve_response_code( $response );
...
function jp_richedit_pre($text) {
	...
	if ( empty( $text ) ) {
		 ...
		 * is passed to jp_richedit_pre(). If an empty string is passed, it results
		 * in a break tag and line feed.
		 *
		 * If a non-empty string is passed, the filter is evaluated on the jp_richedit_pre()
	...
	/** This filter is documented in jp-includes/deprecated.php */
 ...
 */
function jp_htmledit_pre($output) {
	_deprecated_function( __FUNCTION__, '4.3.0', 'format_for_editor()' );
 ...
 * @see get_permalink()
 *
 * @param int|JP_Post $post_id Optional. Post ID or JP_Post object. Default is global $post.
 * @return string|false
 */
 ...
 */
function jp_get_http( $url, $file_path = false, $red = 1 ) {
	_deprecated_function( __FUNCTION__, '4.4.0', 'JP_Http' );
	...
	$response = jp_safe_remote_request( $url, $options );

	if ( is_jp_error( $response ) )
		return false;

	$headers = jp_remote_retrieve_headers( $response );
	$headers['response'] = jp_remote_retrieve_response_code( $response );

	// JP_HTTP no longer follows redirects for HEAD requests.
	if ( 'HEAD' == $options['method'] && in_array($headers['response'], array(301, 302)) && isset( $headers['location'] ) ) {
		return jp_get_http( $headers['location'], $file_path, ++$red );
	}
	...
	fwrite( $out_fp,  jp_remote_retrieve_body( $response ) );
	fclose($out_fp);
	clearstatcache();
 ...
 */
function jp_embed_handler_googlevideo( $matches, $attr, $url, $rawattr ) {
 ...
 * @return string
 */
function jp_kses_js_entities( $string ) {
	_deprecated_function( __FUNCTION__, '4.7.0' );
...
function _usort_terms_by_ID( $a, $b ) {
	_deprecated_function( __FUNCTION__, '4.7.0', 'jp_list_sort()' );
...
* @deprecated 4.9.0
*/
function jp_ajax_press_this_save_post() {
	_deprecated_function( __FUNCTION__, '4.9.0' );
	if ( is_plugin_active( 'press-this/press-this-plugin.php' ) ) {
		include( JP_PLUGIN_DIR . '/press-this/class-jp-press-this-plugin.php' );
		$jp_press_this = new JP_Press_This_Plugin();
		$jp_press_this->save_post();
	} else {
		jp_send_json_error( array( 'errorMessage' => __( 'The Press This plugin is required.' ) ) );
	}
}
...
* @deprecated 4.9.0
*/
function jp_ajax_press_this_add_category() {
	_deprecated_function( __FUNCTION__, '4.9.0' );
	if ( is_plugin_active( 'press-this/press-this-plugin.php' ) ) {
		include( JP_PLUGIN_DIR . '/press-this/class-jp-press-this-plugin.php' );
		$jp_press_this = new JP_Press_This_Plugin();
		$jp_press_this->add_category();
	} else {
		jp_send_json_error( array( 'errorMessage' => __( 'The Press This plugin is required.' ) ) );
	}
}
