...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://codex.jonpress.org/Settings_Reading_Screen">Documentation on Reading Settings</a>' ) . '</p>' .
...
<ul>
	...
	<?php
	printf(
		__( 'Homepage: %s' ), jp_dropdown_pages(
			array(
				'name'              => 'page_on_front',
				'echo'              => 0,
...
?>
	...
	<?php
	printf(
		__( 'Posts page: %s' ), jp_dropdown_pages(
			array(
				'name'              => 'page_for_posts',
				'echo'              => 0,
				'show_option_none'  => __( '&mdash; Select &mdash;' ),
