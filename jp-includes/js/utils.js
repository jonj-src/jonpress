...
function setUserSetting( name, value, _del ) {
	...
	var uid = userSettings.uid,
		settings = wpCookies.getHash( 'jp-settings-' + uid ),
	...
	wpCookies.setHash( 'jp-settings-' + uid, settings, 31536000, path, '', secure );
	wpCookies.set( 'jp-settings-time-' + uid, userSettings.time, 31536000, path, '', secure );
...
function getAllUserSettings() {
	...
	return wpCookies.getHash( 'jp-settings-' + userSettings.uid ) || {};
}
