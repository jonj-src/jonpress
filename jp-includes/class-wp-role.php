...
class JP_Role {
	...
	public function add_cap( $cap, $grant = true ) {
		...
		jp_roles()->add_cap( $this->name, $cap, $grant );
	}

	/**
	 * Removes a capability from a role.
	 *
	 * This is a container for JP_Roles::remove_cap() to remove the
	 * capability from the role. That is to say, that JP_Roles::remove_cap()
	...
	public function remove_cap( $cap ) {
		...
		jp_roles()->remove_cap( $this->name, $cap );
	}
