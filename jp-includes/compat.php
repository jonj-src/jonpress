<?php
/**
 * JonPress implementation for PHP functions either missing from older PHP versions or not included by default.
 *
 * @package PHP
 * @access private
 */
 ...
 */
function _jp_can_use_pcre_u( $set = null ) {
...
if ( ! function_exists( 'json_encode' ) ) {
	function json_encode( $string ) {
		...
		if ( ! ( $jp_json instanceof Services_JSON ) ) {
			require_once( ABSPATH . WPINC . '/class-json.php' );
			$jp_json = new Services_JSON();
		}

		return $jp_json->encodeUnsafe( $string );
	}
}

if ( ! function_exists( 'json_decode' ) ) {
	/**
	 * @global Services_JSON $jp_json
	 * @param string $string
...
// Defined here to prevent a notice when using it with jp_json_encode()
...
if ( ! interface_exists( 'JsonSerializable' ) ) {
	define( 'JP_JSON_SERIALIZE_COMPATIBLE', true );
	/**
...
if ( ! function_exists( 'array_replace_recursive' ) ) :
	 ...
	 *
	 * The array_replace_recursive() function is a PHP 5.3 function. JonPress
	 ...
	 *
	 * Subject to removal once JonPress makes PHP 5.3.0 the minimum requirement.
	 *
	 * @since 4.5.3
	 *
