<?php
/**
 * JonPress Export Administration API
 *
 * @package JonPress
...
function export_wp( $args = array() ) {
	...
	$date        = date( 'Y-m-d' );
	$jp_filename = $sitename . 'JonPress.' . $date . '.xml';
	/**
	 * Filters the export filename.
	 *
	 * @since 4.4.0
	 *
	 * @param string $jp_filename The name of the file for download.
	 * @param string $sitename    The site name.
	 * @param string $date        Today's date, formatted.
	 */
	$filename = apply_filters( 'export_jp_filename', $jp_filename, $sitename, $date );
	...
	function wxr_site_url() {
		...
		} // JonPress (single site): the blog URL.
		else {
	 ...
	 * @since 4.6.0
	 *
	 * @param JP_Term $term Term object.
	 */
	...
	function wxr_post_taxonomy() {
		...
		$terms = jp_get_object_terms( $post->ID, $taxonomies );
	...
	?>
<!-- This is a JonPress eXtended RSS file generated by JonPress as an export of your site. -->
<!-- It contains information about your site's posts, pages, comments, categories, and other content. -->
<!-- You may use this file to transfer that content from one site to another. -->
<!-- This file is not intended to serve as a complete backup of your site. -->

<!-- To import this information into a JonPress site follow these steps: -->
<!-- 1. Log in to that site as an administrator. -->
<!-- 2. Go to Tools: Import in the JonPress admin panel. -->
<!-- 3. Install the "JonPress" importer from the list. -->
<!-- 4. Activate & Run Importer. -->
<!-- 5. Upload this file using the form provided on that page. -->
<!-- 6. You will first be asked to map the authors in this export file to users -->
<!--    on the site. For each author, you may choose to map to an -->
<!--    existing user on the site or to create a new user. -->
<!-- 7. JonPress will then import each of the posts, pages, comments, categories, etc. -->
<!--    contained in this file into your site. -->

<?php the_generator( 'export' ); ?>
<rss version="2.0"
	xmlns:excerpt="http://jonj.tk/export/<?php echo WXR_VERSION; ?>/excerpt/"
	xmlns:content="http://purl.org/rss/1.0/modules/content/"
	xmlns:wfw="http://wellformedweb.org/CommentAPI/"
	xmlns:dc="http://purl.org/dc/elements/1.1/"
	xmlns:wp="http://jonj.tk/export/<?php echo WXR_VERSION; ?>/"
>
...
?>
	...
	<?php
	/** This action is documented in jp-includes/feed-rss2.php */
	do_action( 'rss2_head' );
	?>
...
if ( $post_ids ) {
	...
	<item>
		<title>
		<?php
			/** This filter is documented in jp-includes/feed.php */
	...
	<?php	if ( $post->post_type == 'attachment' ) : ?>
		<wp:attachment_url><?php echo wxr_cdata( jp_get_attachment_url( $post->ID ) ); ?></wp:attachment_url>
	<?php endif; ?>
