...
_.extend( media, /** @lends wp.media */{
	 ...
	 *
	 * See wp.template() in `jp-includes/js/jp-util.js`.
	 *
	 ...
	 *
	 * Sends a POST request to JonPress.
	 * See wp.ajax.post() in `jp-includes/js/jp-util.js`.
	 *
	 ...
	 *
	 * Sends an XHR request to JonPress.
	 * See wp.ajax.send() in `jp-includes/js/jp-util.js`.
	 *
...
Query = Attachments.extend(/** @lends wp.media.model.Query.prototype */{
	...
	orderby: {
		...
		/**
		 * A map of JavaScript orderby values to their JP_Query equivalents.
		 * @type {Object}
		 */
		valuemap: {
			'id':         'ID',
	...
	/**
	 * A map of JavaScript query properties to their JP_Query equivalents.
	 *
	 * @readonly
	 */
	propmap: {
