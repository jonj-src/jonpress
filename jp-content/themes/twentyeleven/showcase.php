...
jp_enqueue_script( 'twentyeleven-showcase', get_template_directory_uri() . '/js/showcase.js', array( 'jquery' ), '2011-04-28' );
		...
		<div id="primary" class="showcase">
			<div id="content" role="main">
				...
				if ( ! empty( $sticky ) ) :
					...
					$featured = new JP_Query( $featured_args );
				...
				while ( $featured->have_posts() ) :
					...
					*/
					...
					if ( has_post_thumbnail() ) {
						...
						$image = jp_get_attachment_image_src( get_post_thumbnail_id( $post->ID ), array( $header_image_width, $header_image_width ) );
				...
				<section class="recent-posts">
					...
					$recent = new JP_Query( $recent_args );
