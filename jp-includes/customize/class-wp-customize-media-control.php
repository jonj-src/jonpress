<?php
/**
 * Customize API: JP_Customize_Media_Control class
 *
 * @package JonPress
 ...
 */
class JP_Customize_Media_Control extends JP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @since 4.2.0
	 ...
	 *
	 * @since 4.1.0
	 * @since 4.2.0 Moved from JP_Customize_Upload_Control.
	 *
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->button_labels = jp_parse_args( $this->button_labels, $this->get_default_button_labels() );
	}
	 ...
	 * @since 4.2.0 Moved from JP_Customize_Upload_Control.
	 *
	 * @see JP_Customize_Control::to_json()
	 */
	public function to_json() {
		...
		if ( is_object( $this->setting ) ) {
			...
			if ( $value && $this->setting->default && $value === $this->setting->default ) {
				...
				$this->json['attachment'] = jp_prepare_attachment_for_js( $value );
			}
		}
	}
	 ...
	 * @since 4.2.0 Moved from JP_Customize_Upload_Control.
	 *
	 * @see JP_Customize_Media_Control::content_template()
	 */
			...
			<div class="attachment-media-view attachment-media-view-{{ data.attachment.type }} {{ data.attachment.orientation }}">
				<div class="thumbnail thumbnail-{{ data.attachment.type }}">
					...
					<# } else if ( 'video' === data.attachment.type ) { #>
						<div class="jp-media-wrapper jp-video">
