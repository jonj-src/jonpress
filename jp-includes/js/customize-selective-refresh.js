...
wp.customize.selectiveRefresh = ( function( $, api ) {
	 ...
	 *
	 * @see PHP class JP_Customize_Partial.
	 *
	 * @class
	...
	Partial = self.Partial = api.Class.extend(/** @lends wp.customize.SelectiveRefresh.Partial.prototype */{
		...
		renderContent: function( placement ) {
			...
			/*
			 * Note that the 'jp_audio_shortcode_library' and 'jp_video_shortcode_library' filters
			 * will determine whether or not wp.mediaelement is loaded and whether it will
			 * initialize audio and video respectively. See also https://core.trac.jonpress.org/ticket/40144
			 */
			if ( wp.mediaelement ) {
