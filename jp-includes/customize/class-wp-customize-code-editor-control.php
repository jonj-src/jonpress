<?php
/**
 * Customize API: JP_Customize_Code_Editor_Control class
 *
 * @package JonPress
 ...
 */
class JP_Customize_Code_Editor_Control extends JP_Customize_Control {
	...
	public function enqueue() {
		$this->editor_settings = jp_enqueue_code_editor(
			array_merge(
				array(
					'type'       => $this->code_type,
					'codemirror' => array(
