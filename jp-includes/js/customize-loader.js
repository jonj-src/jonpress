...
(function( exports, $ ){
	 ...
	 *
	 *     e.g. <a class="load-customize" href="<?php echo jp_customize_url(); ?>">Open Customizer</a>
	 *
	...
	Loader = $.extend( {}, api.Events,/** @lends wp.customize.Loader.prototype */{
		...
		hashchange: function() {
			...
			if ( hash && 0 === hash.indexOf( 'jp_customize=on' ) ) {
		...
		pushState: function ( src ) {
			...
			if ( $.support.history && window.location.href !== src ) {
				...
				window.location.hash = 'jp_customize=on&' + hash;
			}
