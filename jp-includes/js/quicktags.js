 ...
 * Quicktags
 *
 * This is the HTML editor in JonPress. It can be attached to any textarea and will
...
(function(){
	...
	qt = QTags = function(settings) {
		...
		wrap = document.getElementById( 'jp-' + id + '-wrap' );
	 ...
	 * use add_action( 'admin_print_footer_scripts', 'output_my_js', 100 ) or add_action( 'jp_footer', 'output_my_js', 100 )
	 *
