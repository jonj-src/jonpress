<?php
/**
 * REST API: JP_REST_Settings_Controller class
 *
 * @package JonPress
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class JP_REST_Settings_Controller extends JP_REST_Controller {
	 ...
	 *
	 * @param JP_REST_Request $request Full details about the request.
	 * @return array|JP_Error Array on success, or JP_Error object on failure.
	 */
	...
	protected function prepare_value( $value, $schema ) {
		...
		if ( is_jp_error( rest_validate_value_from_schema( $value, $schema ) ) ) {
			return null;
		}
	 ...
	 *
	 * @param JP_REST_Request $request Full details about the request.
	 * @return array|JP_Error Array on success, or error object on failure.
	 */
	public function update_item( $request ) {
		...
		foreach ( $options as $name => $args ) {
			...
			if ( is_null( $request[ $name ] ) ) {
				 ...
				 * database.
				 */
				if ( is_jp_error( rest_validate_value_from_schema( get_option( $args['option_name'], false ), $args['schema'] ) ) ) {
					return new JP_Error(
	 ...
	 * @param  JP_REST_Request $request The request object.
	 * @param  string          $param   The parameter name.
	 * @return mixed|JP_Error
	 */
