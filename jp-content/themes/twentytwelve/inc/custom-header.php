 ...
 *
 * See https://codex.jonpress.org/Custom_Headers
 *
 * @package JonPress
 ...
 * @uses twentytwelve_admin_header_style() to style jp-admin form.
 * @uses twentytwelve_admin_header_image() to add custom markup to jp-admin form.
 *
 * @since Twenty Twelve 1.0
 */
function twentytwelve_custom_header_setup() {
	$args = array(
		...
		'jp-head-callback'       => 'twentytwelve_header_style',
