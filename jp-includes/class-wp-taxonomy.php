<?php
/**
 * Taxonomy API: JP_Taxonomy class
 *
 * @package JonPress
 * @subpackage Taxonomy
 * @since 4.7.0
...
final class JP_Taxonomy {
	...
	public function add_hooks() {
		add_filter( 'jp_ajax_add-' . $this->name, '_jp_ajax_add_hierarchical_term' );
	}
	...
	public function remove_hooks() {
		remove_filter( 'jp_ajax_add-' . $this->name, '_jp_ajax_add_hierarchical_term' );
	}
}
