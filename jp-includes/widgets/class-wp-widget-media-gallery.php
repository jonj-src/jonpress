<?php
/**
 * Widget API: JP_Widget_Media_Gallery class
 *
 * @package JonPress
 * @subpackage Widgets
 * @since 4.9.0
 ...
 * @see JP_Widget
 */
class JP_Widget_Media_Gallery extends JP_Widget_Media {
	...
	public function get_instance_schema() {
		$schema = array(
			...
			'ids'            => array(
				...
				'default'           => array(),
				'sanitize_callback' => 'jp_parse_id_list',
			),
			'columns'        => array(
				'type'    => 'integer',
				'default' => 3,
		...
		/** This filter is documented in jp-includes/widgets/class-jp-widget-media.php */
	...
	public function enqueue_admin_scripts() {
		...
		foreach ( $this->get_instance_schema() as $field => $field_schema ) {
			$exported_schema[ $field ] = jp_array_slice_assoc( $field_schema, array( 'type', 'default', 'enum', 'minimum', 'format', 'media_prop', 'should_preview_update', 'items' ) );
		}
	...
	public function render_control_template_scripts() {
		...
		?>
		<script type="text/html" id="tmpl-jp-media-widget-gallery-preview">
	...
	protected function has_content( $instance ) {
		if ( ! empty( $instance['ids'] ) ) {
			$attachments = jp_parse_id_list( $instance['ids'] );
