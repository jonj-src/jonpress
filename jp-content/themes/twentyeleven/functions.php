...
/*
 * Tell JonPress to run twentyeleven_setup() when the 'after_setup_theme' hook is run.
 */
...
if ( ! function_exists( 'twentyeleven_setup' ) ) :
	...
	function twentyeleven_setup() {
		...
		$custom_header_support = array(
			...
			'jp-head-callback'       => 'twentyeleven_header_style',
		...
		if ( ! function_exists( 'get_custom_header' ) ) {
			...
			add_custom_image_header( $custom_header_support['jp-head-callback'], $custom_header_support['admin-head-callback'], $custom_header_support['admin-preview-callback'] );
...
/**
 * Show a home link for the jp_nav_menu() fallback, jp_page_menu().
 *
 * @since Twenty Eleven 1.0
 *
 * @param array $args The page menu arguments. @see jp_page_menu()
...
add_filter( 'jp_page_menu_args', 'twentyeleven_page_menu_args' );
