<?php
/**
 * Customize API: JP_Customize_Partial class
 *
 * @package JonPress
 ...
 * This class is analogous of JP_Customize_Control.
 *
 * @since 4.5.0
 */
class JP_Customize_Partial {
	 ...
	 *
	 * @since 4.5.0
	 * @see JP_Customize_Partial::render()
	 * @var callable Callback is called with one argument, the instance of
	 *                 JP_Customize_Partial. The callback can either echo the
	 ...
	 * @since 4.5.0
	 *
	 * @param JP_Customize_Selective_Refresh $component Customize Partial Refresh plugin instance.
	 ...
	 * }
	 */
	public function __construct( JP_Customize_Selective_Refresh $component, $id, $args = array() ) {
	...
	final public function render( $container_context = array() ) {
		 ...
		 * @param JP_Customize_Partial $partial           JP_Customize_Setting instance.
	...
	/**
	 * Default callback used when invoking JP_Customize_Control::render().
	 *
	 ...
	 */
	public function render_callback( JP_Customize_Partial $partial, $context = array() ) {
