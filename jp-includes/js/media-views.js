...
UploaderWindow = wp.media.View.extend(/** @lends wp.media.view.UploaderWindow.prototype */{
	...
	hide: function() {
		...
		// https://core.trac.jonpress.org/ticket/27341
		_.delay( function() {
...
/**
 * Creates a dropzone on WP editor instances (elements with .jp-editor-wrap)
...
EditorUploader = View.extend(/** @lends wp.media.view.EditorUploader.prototype */{
	...
	render: function() {
		...
		$( '.jp-editor-wrap' ).each( _.bind( this.attach, this ) );
		return this;
	},
	...
	drop: function( event ) {
		...
		$wrap = $( event.target ).parents( '.jp-editor-wrap' );
...
AttachmentsBrowser = View.extend(/** @lends wp.media.view.AttachmentsBrowser.prototype */{
	...
	createToolbar: function() {
		...
		if ( this.controller.isModeActive( 'grid' ) ) {
			toolbarOptions.className = 'media-toolbar jp-filter';
		}
