<?php
/**
 * Dependencies API: JP_Styles class
 *
 * @since 2.6.0
 *
 * @package JonPress
 ...
 * @see JP_Dependencies
 */
class JP_Styles extends JP_Dependencies {
	/**
	 * Base URL for styles.
	 *
	...
	public function __construct() {
		/**
		 * Fires when the JP_Styles instance is initialized.
		 *
		 * @since 2.6.0
		 *
		 * @param JP_Styles $this JP_Styles instance (passed by reference).
		 */
		do_action_ref_array( 'jp_default_styles', array( &$this ) );
	}
	...
	public function do_item( $handle ) {
		...
		if ( 'rtl' === $this->text_direction && isset( $obj->extra['rtl'] ) && $obj->extra['rtl'] ) {
			...
			/** This filter is documented in jp-includes/class.jp-styles.php */
