<?php
/**
 * HTTP API: JP_Http_Encoding class
 *
 * @package JonPress
 * @subpackage HTTP
 * @since 4.4.0
...
class JP_Http_Encoding {
	 ...
	 * https://core.trac.jonpress.org/ticket/18273
	 *
	 * @since 2.8.1
	 * @link https://core.trac.jonpress.org/ticket/18273
	...
	public static function accept_encoding( $url, $args ) {
		 ...
		 */
		$type = apply_filters( 'jp_http_accept_encoding', $type, $url, $args );
